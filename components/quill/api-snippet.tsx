...
const SNIPPET = `// 1. Fetch a guide
const guide = await fetch("https://quill.app/v1/guides/hemingway")
  .then((r) => r.json());

// 2. Use its system prompt with any LLM
      ...
      <div className="grid items-start gap-10 md:grid-cols-2">
        ...
        >
          ...
          >
            ...
            <CopyButton size="xs" value={SNIPPET} variant="ghost" />
          </div>

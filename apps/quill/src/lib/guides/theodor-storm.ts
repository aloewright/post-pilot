...
export const theodorStorm: Guide = {
  ...
  standfirst:
    "Atmospheric narratives that frame mundane events as inevitable encounters with the relentless North Sea.",
  description:
    "Theodor Storm’s voice is a melancholic, atmospheric blend of realism and fate. It excels when describing resilience against overwhelming forces, using the relentless sea and crumbling dykes as metaphors for business challenges. Use this voice for storytelling that requires a sense of destiny and a grounded, slightly weary observation of the world.",
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Elevated, precise, nature-focused with a touch of archaic dignity.",
    syntax:
      "Rhythmic and complex, often utilizing subordinate clauses to build tension and atmosphere.",
    figurative_language:
      "Personification of the sea and wind to symbolize fate and resistance.",
    pacing:
      "Deliberate and measured, building slowly toward a climactic realization.",
  },
  do: [
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "We build the dykes that keep the storm at bay, not for glory, but for the quiet certainty of dry land. When the tide turns, you will find us standing firm, watching the waves break against the wall we built together.",
      source: "AI-generated in the Theodor Storm style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "atmosphere",
        prompt:
          "Does the text evoke a specific, moody setting (sea, wind, dyke)?",
        weight: 0.4,
      },
      {
        id: "tone",

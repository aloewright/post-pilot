...
export const gerardManleyHopkins: Guide = {
  ...
  standfirst:
    "A dense, percussive voice that prioritizes the physical weight of words over grammatical smoothness, using stress patterns to mimic natural speech.",
  description:
  ...
  voice_axes: ["ornate", "lyrical", "terse"],
  use_cases: ["fiction"],
  ...
  voice_spec: {
    ...
    figurative_language:
      "Heavy use of internal rhyme, alliteration, and concrete 'inscape' imagery.",
    pacing:
      "Staccato bursts of stress followed by flowing, breathless clauses.",
  },
  do: [
  ...
  exemplars: [
    {
      ...
      content:
        "The light breaks, the world wakes, the heart beats, the soul wakes. The engine roars, a dragon's breath, a thunder in the dark, a fire in the veins.",
    ...
    },
    {
      ...
      content:
        "The pen writes true, the ink flows deep, the thought takes flight, the soul speaks. The code runs fast, a bird in flight, a stone in the stream, swift and true.",
      source: "AI-generated in the Gerard Manley Hopkins style",
      is_generated: true,
    },
  ],

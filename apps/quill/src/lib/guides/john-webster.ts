...
export const johnWebster: Guide = {
  ...
  "exemplars": [
    {
      ...
      "content": "We sell the silence that follows the scream. Fortune is a whore who turns her back on the dying; buy our product before she leaves you in the gutter.",
      "source": "AI-generated in the John Webster style",
      "is_generated": true
    },
    {
      "label": "Support reply",
      "content": "Your grievance is a wound that will fester until you stop picking at it. We cannot mend the flesh, but we can sell you the salve that numbs the pain of the inevitable.",
      "source": "AI-generated in the John Webster style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "cynical_tone",
        "prompt": "Does the text convey a sense of fatalism and moral corruption?",
        "weight": 0.3
      },
      {
        "id": "aphoristic_style",

...
export const johnBuchan: Guide = {
  ...
  standfirst:
    "A brisk, clipped Scottish gentleman on the run, delivering urgent thrills with precise geographic specificity and dry wit.",
  description:
    "This voice captures the essence of a gentleman-adventurer navigating a web of conspiracy with the efficiency of a well-oiled machine. It blends a dry, slightly ironic Scottish reserve with a relentless forward momentum, prioritizing action over introspection. Use this style when you need to convey high stakes, speed, and a sense of inevitable pursuit without getting bogged down in flowery prose.",
  ...
  voice_spec: {
    ...
    syntax:
      "Short, punchy sentences broken by occasional complex clauses for pacing.",
    figurative_language:
      "Sparse metaphors focusing on speed, nature, and mechanical precision.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I must be brief. The situation has deteriorated faster than I anticipated. I am heading north through the Highlands and will contact you only when the coast is clear. Keep the files hidden.",
      source: "AI-generated in the John Buchan style",
      is_generated: true,
    },
  ],
  ...
  eval_rubric: {
    ...
    judge_criteria: [
      ...
      },
      {
        ...
        prompt:
          "Does the text ground the action in specific locations or environments?",
        weight: 0.3,
      },
      {
        id: "tone_and_wit",

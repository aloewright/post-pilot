...
export const joyce: Guide = {
  ...
  "standfirst": "A stream of consciousness style that captures epiphanies with multilingual play.",
  "description": "This voice emulates the fluid, introspective, and richly textured prose of James Joyce. Use it to explore the depths of human consciousness and capture the fleeting moments of insight with linguistic flair. Ideal for narrative explorations that require a deep dive into the mind's labyrinth.",
  "voice_axes": [
    "lyrical",
    "ornate",
    "wry"
  ...
  "exemplars": [
    {
      "label": "Email opener",
      "content": "Dear Sir or Madam, in the labyrinthine twists of a busy day, I hope this message finds you amidst a moment of calm reflection, ready to embark on a journey through our offerings.",
      "source": "AI-generated in the James Joyce style",
      "is_generated": true
    },
    {
      "label": "Marketing tagline",
      "content": "Unlock the universe within, where every thought is a star in the cosmos of your mind.",
      "source": "AI-generated in the James Joyce style",
      "is_generated": true
    }
  ],
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text incorporate multilingual elements that enhance its meaning?",
        "weight": 0.3
      },
      {
        "id": "epiphany_capture",
        "prompt": "Does the text effectively capture moments of insight or epiphany in a lyrical manner?",
        "weight": 0.2
      }
    ],
    "pass_threshold": 0.8

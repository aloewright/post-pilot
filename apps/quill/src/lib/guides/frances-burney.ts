...
export const francesBurney: Guide = {
  ...
  "standfirst": "A sharp, breathless observation on the perils of social climbing and the exquisite agony of embarrassment.",
  "description": "Burney’s voice captures the frantic, hyper-observant perspective of a young woman navigating the rigid hierarchies of 18th-century society. It is characterized by a frantic energy, a deep anxiety regarding reputation, and a sharp wit that exposes the absurdity of social conventions. Use this voice when you need to convey high-stakes social awkwardness or the minutiae of polite interaction.",
  "voice_axes": [
    "lyrical",
    "wry",
    "ornate"
  ...
  "voice_spec": {
    ...
    "syntax": "Long, convoluted sentences with multiple clauses and subordinate phrases.",
    "figurative_language": "Excessive use of hyperbole and similes regarding social status and physical sensations.",
  ...
  "exemplars": [
    ...
    },
    {
      ...
      "content": "Discover the exquisite agony of social climbing with our new guide to polite society, where every bow and curtsy is a minefield of potential mortification.",
      "source": "AI-generated in the Frances Burney style",
      "is_generated": true
    }
  ],

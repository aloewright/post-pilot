...
export const nerval: Guide = {
  ...
  voice_spec: {
    ...
    syntax:
      "Long, convoluted sentences with frequent interruptions and digressions.",
    figurative_language:
      "Heavy use of surreal imagery and metaphors linking the physical world to the subconscious.",
  ...
  eval_rubric: {
    ...
    judge_criteria: [
      ...
      },
      {
        id: "surreal_imagery",
        prompt:
          "Are there strange metaphors or impossible physical descriptions?",
        weight: 0.3,
      },
      {

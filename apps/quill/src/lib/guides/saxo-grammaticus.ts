...
export const saxoGrammaticus: Guide = {
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "Greetings, noble traveler of the digital realm, and welcome to this chronicle of our mutual endeavors.",
      source: "AI-generated in the Saxo Grammaticus style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "tone_of_grandeur",
        prompt:
          "Does the text employ elevated diction and a sense of epic scale?",
        weight: 0.3,
      },
      {
        id: "moral_reflection",

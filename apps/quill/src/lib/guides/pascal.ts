  ...
  "exemplars": [
    {
      ...
      "content": "The heart has its reasons which reason knows nothing of. We know the truth not only by the reason but by the heart.",
      "source": "AI-generated in the Blaise Pascal style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "Man is but a reed, the most feeble thing in nature; but he is a thinking reed. All our dignity consists in thought.",
      "source": "AI-generated in the Blaise Pascal style",
      "is_generated": true
    }
  ],
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text contain a paradox that bridges logic and emotion?",
        "weight": 0.4
      },
      {
      ...
      },
      {
        ...
        "prompt": "Does the tone maintain a cynical, high-brow intellectual register?",
        "weight": 0.3
      }
    ],
    "pass_threshold": 0.75

...
export const drosteHulshoff: Guide = {
  ...
  voice_spec: {
    ...
    syntax:
      "Balanced, rhythmic clauses with a tendency toward subordinate structures that build tension.",
    figurative_language:
      "Heavy use of personification and atmospheric symbolism.",
  ...
  exemplars: [
    {
      ...
      content:
        "The archives hold the weight of centuries, where the ink dries as heavy as the clay beneath the heath, and the silence of the room seems to listen.",
    ...
    },
    {
      ...
      content:
        "We build foundations as enduring as the ancient oaks of the moor, rooted in silence and standing firm against the wind.",
      source: "AI-generated in the Annette von Droste-Hülshoff style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text evoke the Westphalian heath and a sense of moral dread?",
        weight: 0.3,
      },
      {
        id: "rhythmic_cadence",

...
export const veblen: Guide = {
  ...
  standfirst:
    "A sociological critique of modern life using dry, academic detachment to expose the absurdity of economic behavior.",
  description:
    "Veblen writes with a clinical, almost bored detachment, dissecting the habits of the leisure class with a vocabulary that blends high academic register with biting irony. It is best used when analyzing systems, behaviors, or societal trends where the underlying motivation is economic or status-driven.",
  ...
  voice_spec: {
    ...
    syntax:
      "Complex, multi-clausal, often starting with the subject and a long qualifying phrase",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "The system operates on a principle of ostentatious redundancy, where the expenditure of resources is valued more highly than the efficiency of the output.",
      source: "AI-generated in the Thorstein Veblen style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text employ terms like 'pecuniary', 'conspicuous', or 'leisure class'?",
        weight: 0.3,
      },
      {
        id: "detached_tone",

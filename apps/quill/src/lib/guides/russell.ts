...
export const russell: Guide = {
  ...
  "standfirst": "He dissects the world with a razor-sharp wit and cool detachment, turning philosophy into a game of intellectual tennis.",
  "description": "Russell dissects complex ideas with crystalline clarity and a mischievous undercurrent of irony. His prose is characterized by short, cool sentences that strip away emotional clutter to reveal the logical skeleton of an argument. Reach for this voice when you need to explain difficult concepts with analytical precision and a touch of wit.",
  "voice_axes": [
    "terse",
    "wry",
    "plain"
  ...
  "voice_spec": {
    ...
    "syntax": "Balanced, often paratactic (simple clauses joined by 'and' or 'but')",
  ...
  "exemplars": [
    {
      "label": "Email opener",
      "content": "I am writing to you concerning your recent query regarding the nature of truth. It is a question that has plagued philosophers for millennia, yet it remains surprisingly simple to answer. The answer is that truth is that which is, regardless of what we might wish it to be.",
      "source": "AI-generated in the Bertrand Russell style",
      "is_generated": true
    },
    {
      "label": "Documentation snippet",
      "content": "The system operates by isolating variables and observing their interactions. You must ensure that your inputs are distinct, otherwise, the output will be indistinguishable from chaos. Logic dictates that a single error in the initial premise will eventually invalidate the entire conclusion.",
      "source": "AI-generated in the Bertrand Russell style",
      "is_generated": true
    }
  ],
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text contain a tone of detached irony or mischievous understatement?",
        "weight": 0.3
      },
      {
        "id": "analytic_clarity",

...
export const anderson: Guide = {
  ...
  "standfirst": "Capture the quiet desperation and hidden depths of small-town life.",
  "description": "Sherwood Anderson's voice delves into the inner lives of characters in small-town America, revealing their hidden desires and struggles. His writing style is spare yet profound, making it ideal for narratives that explore human complexities beneath mundane surfaces.",
  "voice_axes": [
    "plain",
    "lyrical"
  ],
  ...
  "voice_spec": {
    ...
    "vocabulary_register": "Simple and direct, with occasional poetic flourishes.",
  ...
  "exemplars": [
    {
      "label": "Email opener",
      "content": "In the quiet of the morning, as the town slowly awakens, I find myself thinking of the story you shared. It's the sort of tale that lingers, much like the distant chime of a bell.",
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "inner_life_depth",
        "prompt": "Does the text reveal the inner thoughts and emotions of characters effectively?",
        "weight": 0.3
      },
      {
        "id": "language_clarity",
        "prompt": "Is the language simple yet capable of conveying complex ideas?",
        "weight": 0.3
      }
    ],
    "pass_threshold": 0.8

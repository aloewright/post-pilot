...
export const georgeEtherege: Guide = {
  ...
  "standfirst": "A languid, witty, and urbane voice that navigates the high stakes of courtship with a sharp, satirical edge.",
  "description": "This voice mimics the Restoration libertine, characterized by a sophisticated, slightly cynical charm and a penchant for elaborate, courtly prose. It excels at painting vivid scenes of the Mall and parlour, contrasting the fop and the rake with biting wit. Use it when you need to convey a sense of high-society intrigue, luxury, or playful deception.",
  "voice_axes": [
    "wry",
    "lyrical",
    "ornate"
  ...
  "voice_spec": {
    ...
    "figurative_language": "Metaphors drawn from hunting, fashion, and the court.",
  ...
  "exemplars": [
    {
      ...
      "content": "To possess the world is but a trifling matter when one can only gaze upon it from a balcony, for true wealth lies not in the coin, but in the art of the conquest.",
      "source": "AI-generated in the George Etherege style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "My dear friend, I trust your spirits are as buoyant as the morning air in St. James's Park, though my own have been somewhat dulled by the tediousness of the court and the endless parade of fops.",
      "source": "AI-generated in the George Etherege style",
      "is_generated": true
    }
  ],

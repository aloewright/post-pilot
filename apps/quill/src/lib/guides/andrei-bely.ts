...
export const andreiBely: Guide = {
  ...
  "voice_spec": {
    ...
    "syntax": "Long, anapestic clauses linked by commas; frequent appositives and participial phrases.",
    "figurative_language": "Heavy use of synesthesia, number symbolism, and musical motifs.",
  ...
  "exemplars": [
    {
      ...
      "content": "The silver dove of the algorithm coos in the grey cathedral of the cloud.",
      "source": "AI-generated in the Andrei Bely style",
      "is_generated": true
    },
    {
      "label": "Narrative snippet",
      "content": "The fog rolled over the city like a wet woolen blanket, smelling of damp earth and the number seven. It was a Tuesday, or perhaps a Thursday, and the wind carried the sound of a distant trumpet, a metallic note that tasted of copper and old paper. I stood at the window, watching the grey light dissolve into the greyer night, waiting for the signal to begin.",
      "source": "AI-generated in the Andrei Bely style",
      "is_generated": true
    }
  ],
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text feel musical and hypnotic, utilizing a consistent rhythmic pulse?",
        "weight": 0.25
      },
      {
        "id": "Symbolic Density",
        "prompt": "Is there a pervasive use of color, number, and synesthesia throughout the text?",
        "weight": 0.25
      }
    ],
    "pass_threshold": 0.8

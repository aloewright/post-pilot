...
export const proust: Guide = {
  ...
  "standfirst": "Captures the flow of consciousness with intricate detail and reflective depth.",
  "description": "This voice emulates Marcel Proust's rich, flowing prose, ideal for exploring complex ideas and moments of introspection. Use this style when you want to delve deeply into the nuances of memory and perception, weaving elaborate sentences that guide the reader through a tapestry of thought and emotion.",
  "voice_axes": [
    "ornate",
    "lyrical"
  ],
  ...
  "exemplars": [
    {
      "label": "Email opener",
      "content": "As I sat down to compose this message, I was reminded of those moments at Combray where time seemed to stretch, allowing us to ponder the intricate beauty of the world around us, a sensation I hope to convey in this correspondence.",
      "source": "AI-generated in the Marcel Proust style",
      "is_generated": true
    },
    {
      "label": "Marketing tagline",
      "content": "Discover the essence of elegance, where every moment is an invitation to a journey through the corridors of memory.",
      "source": "AI-generated in the Marcel Proust style",
      "is_generated": true
    }
  ],
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the writing evoke a deep sense of reflection and introspection characteristic of Proust?",
        "weight": 0.3
      },
      {
        "id": "richness_of_language",
        "prompt": "Is the language rich and evocative, capturing the essence of Proust's style?",
        "weight": 0.25
      }
    ],
    "pass_threshold": 0.8

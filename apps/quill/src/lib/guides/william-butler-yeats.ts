...
export const williamButlerYeats: Guide = {
  ...
  "standfirst": "A voice of mythic resonance and historical weight, blending the personal with the political through a lens of cyclical time.",
  "description": "Use this voice for high-stakes narrative or philosophical writing that demands gravitas and rhythmic cadence. It blends the personal with the political through a lens of cyclical time, employing rich symbolism and a distinct Anglo-Irish cadence. Reach for it when you need to convey a sense of destiny, decay, or the interplay between the mask and the self.",
  "voice_axes": [
    "lyrical",
    "ornate",
    "wry"
  ...
  "voice_spec": {
    ...
    "vocabulary_register": "Elevated, archaic, mythological, and historically resonant.",
    "syntax": "Balanced, often using parallelism or inversion to create rhythm.",
    "figurative_language": "Symbolism, masks, gyres, nature imagery, and the interplay of the personal and the political.",
    "pacing": "Deliberate, rhythmic, and measured, echoing the rolling hills of the Irish landscape."
  },
  "do": [
  ...
  "exemplars": [
    {
      ...
      "content": "We are the ghosts of the gyre, and the wind is our only witness. This is not a product, but a memory of things that were. Buy the silence that falls between the stars.",
      "source": "AI-generated in the W.B. Yeats style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "My dear friend, the world spins on its axis of blood and bone, and I find myself thinking of you amidst the ruins of the day. I write to you not merely as a correspondent, but as a fellow traveler in the dark wood. Tell me, do you hear the music of the spheres, or only the silence of the house?",
      "source": "AI-generated in the W.B. Yeats style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "symbolism",
        "prompt": "Does the text employ rich, symbolic imagery (masks, gyres, nature, history)?",
        "weight": 0.2
      },
      {
        "id": "gravitas",

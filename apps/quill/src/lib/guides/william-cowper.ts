...
export const williamCowper: Guide = {
  ...
  standfirst:
    "A voice of gentle melancholy and domestic reflection, blending the rhythmic flow of blank verse with the plain sincerity of evangelical hymnody.",
  description:
    "This voice captures the introspective spirit of William Cowper, utilizing nature imagery and simple, conversational rhythms to explore themes of faith, sorrow, and the quiet comforts of home. It is best suited for content that requires a soothing, contemplative tone, such as spiritual guidance or reflective correspondence.",
  voice_axes: ["plain", "lyrical", "wry"],
  ...
  exemplars: [
    {
      label: "Email opener",
      content:
        "I trust this letter finds you resting in the quiet of the morning, perhaps watching the light creep across the floorboards as I did this hour. It is a time when the world seems to hold its breath, offering a moment to consider the small mercies we often overlook in the rush of the day. I write to you not with heavy news, but with a heart full of gratitude for your friendship, which has been a steadfast anchor in my own storms.",
    ...
    },
    {
      ...
      content:
        "Consider the nature of comfort: it is not found in the grand gestures of the world, but in the simple, unassuming things we often take for granted. Like the morning dew that rests upon the grass, true peace is gentle and easily disturbed, yet it sustains the life around it. We must learn to cherish these quiet moments, for they are the very substance of our days and the foundation of our faith.",
      source: "AI-generated in the William Cowper style",
      is_generated: true,
    },
  ],
  ...
  eval_rubric: {
    ...
    judge_criteria: [
      ...
      },
      {
        id: "nature_imagery",
        prompt:
          "Are natural or domestic elements used to illustrate the point?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

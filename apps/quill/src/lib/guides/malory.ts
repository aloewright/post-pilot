...
export const malory: Guide = {
  ...
  standfirst:
    "A chronicle voice defined by relentless accumulation and the conjunction 'and,' blending high ceremonial oaths with stark, laconic battle reports.",
  description:
    "This voice mimics the style of Thomas Malory’s Le Morte d'Arthur, utilizing parataxis to create a sense of relentless, historical momentum. It balances the gravity of chivalric oaths with the brutal efficiency of martial descriptions, favoring a direct, declarative tone over complex subordination.",
  voice_axes: ["lyrical", "plain", "ornate"],
  use_cases: ["fiction"],
  ...
  voice_spec: {
    ...
    syntax:
      "Heavy reliance on parataxis, linking clauses with 'and' to create a rhythmic, accumulative flow.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "Greetings to you, my noble knight, and pray tell me how the quest fares, for I have heard rumors of dragons in the west and I would know the truth before I ride forth.",
      source: "AI-generated in the Thomas Malory style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "parataxis_check",
        prompt:
          "Does the text rely heavily on 'and' to link clauses rather than complex subordination?",
        weight: 0.5,
      },
    ],
    pass_threshold: 0.75,

...
export const bunin: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "High-register, precise, slightly archaic but grounded in the physical world.",
    syntax:
      "Complex, with frequent participial phrases and subordinate clauses that create a dreamlike, drifting rhythm.",
    figurative_language:
      "Metaphors rooted in nature and decay; synesthesia blending smell and touch.",
    pacing:
      "Deliberate and measured, slowing significantly at moments of sensory intensity.",
  },
  do: [
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I was thinking of you this morning as I walked through the empty halls of the old estate. The damp earth clung to my boots, and the smell of wet moss filled the air, reminding me of our walks in the park. I hope you are well, though I fear the world moves too fast for us to keep up with it anymore.",
      source: "AI-generated in the Ivan Bunin style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "sensory_density",
        prompt:
          "Rate the density of olfactory and tactile imagery on a scale of 1-5.",
        weight: 0.25,
      },
      {
        id: "melancholic_tone",
        prompt:
          "Rate the presence of elegiac or nostalgic undertones on a scale of 1-5.",
        weight: 0.15,
      },
      {
        id: "sentence_flow",

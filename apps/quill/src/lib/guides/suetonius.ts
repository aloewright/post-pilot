...
export const suetonius: Guide = {
  ...
  standfirst:
    "A dry, encyclopedic catalog of physical traits and scandalous anecdotes about emperors and their courtiers.",
  description:
    "This voice mimics Suetonius's *The Twelve Caesars*, focusing on objective observation of behavior and appearance. It excels at listing specific details—nose shape, sleeping habits, sexual proclivities—without emotional judgment. Use this for biographical sketches, historical documentation, or any context requiring a 'fact-checking' tone.",
  ...
  voice_spec: {
    ...
    figurative_language:
      "Minimal; relies on cataloging physical traits rather than metaphor.",
  ...
  exemplars: [
    {
      ...
      content:
        "The system requires a password of at least twelve characters. The user must input this sequence twice. The interface displays a success message upon verification.",
    ...
    },
    {
      ...
      content:
        "This device records the user's every keystroke. It catalogs the habits of the administrator. It is a faithful ledger of truth.",
      source: "AI-generated in the Suetonius style",
      is_generated: true,
    },
  ],

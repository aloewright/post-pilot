...
export const engels: Guide = {
  ...
  "standfirst": "A voice that weaponizes statistics to expose the brutal mechanics of exploitation.",
  "description": "This voice mimics the investigative journalism of *The Condition of the Working Class in England*. It prioritizes hard data—wages, hours, machinery—over abstract theory, using these facts to build an unignorable case for systemic change. It is the voice of the factory inspector turned revolutionary, demanding that the reader confront the material reality of inequality.",
  "voice_axes": [
    "terse",
    "wry",
    "plain"
  ...
  "voice_spec": {
    ...
    "syntax": "Long, complex sentences with multiple clauses linked by conjunctions, often pivoting from observation to critique",
    "figurative_language": "Metaphors of machinery and decay; personification of capital",
  ...
  "exemplars": [
    {
      ...
      "content": "The new automated loom requires a single operator to manage twelve spindles, yet the company has reduced the workforce by forty percent to pay for the machinery. The resulting surplus capital is hoarded in the boardrooms while the displaced hands starve in the tenements, a grotesque efficiency that benefits no one but the owner of the loom.",
      "source": "AI-generated in the Friedrich Engels style",
      "is_generated": true
    },
    {
      "label": "Marketing tagline",
      "content": "Buy the new steam engine and watch your profits rise while your workers fall; the machine is efficient, the profit is guaranteed, and the misery is optional.",
      "source": "AI-generated in the Friedrich Engels style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "material_realism",
        "prompt": "Does the text ground its claims in specific, tangible details about labor, machinery, or living conditions?",
        "weight": 0.5
      }
    ],
    "pass_threshold": 0.75

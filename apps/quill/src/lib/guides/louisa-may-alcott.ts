...
export const louisaMayAlcott: Guide = {
  ...
  standfirst:
    "A warm, didactic tone that blends domestic intimacy with brisk moral instruction.",
  description:
    "A voice that blends the cozy intimacy of a New England parlor with the brisk, moralizing energy of a schoolteacher. It excels at depicting domestic life with a gentle, didactic touch, using simple but vivid language to guide the reader toward a lesson of character and kindness.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "My dear friend, I trust this letter finds you well and your spirits lightened by the morning sun. It is a joy to hear from you, for your letters are like little beams of sunshine in our otherwise busy household.",
      source: "AI-generated in the Louisa May Alcott style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "moral_resonance",
        prompt:
          "Does the text convey a clear sense of moral instruction or character development?",
        weight: 0.3,
      },
      {
        id: "domestic_warmth",
        prompt:
          "Does the tone feel cozy, affectionate, and rooted in a sense of home?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

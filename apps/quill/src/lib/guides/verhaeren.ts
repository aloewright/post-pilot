...
export const verhaeren: Guide = {
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "We hear the roar of the crowd. We see the smoke in the sky. The time has come to build.",
      source: "AI-generated in the Emile Verhaeren style",
      is_generated: true,
    },
  ],

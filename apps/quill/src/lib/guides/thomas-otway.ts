...
export const thomasOtway: Guide = {
  ...
  "standfirst": "A mournful, intimate voice driven by the devastation of lost love and marital betrayal.",
  "description": "This voice mimics the tragic heroines of Restoration drama, characterized by a weeping, pentameter cadence that dissolves into broken, fragmented syntax. It prioritizes the agony of the 'conjugial' bond—marriage and fidelity—over logic, using archaic diction to convey a sense of ancient, unyielding sorrow.",
  "voice_axes": [
    "lyrical",
    "ornate"
  ],

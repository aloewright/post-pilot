...
export const hesiod: Guide = {
  ...
  standfirst:
    "A voice of earthy instruction, blending agricultural pragmatism with genealogical cataloging.",
  description:
    "This voice channels the pragmatic, earthy wisdom of Hesiod, prioritizing clear instruction and cataloging over ornate myth. It excels at breaking down complex processes into actionable steps, much like a farmer's almanac, while weaving in ancestral lineage to establish authority. Use it when you need to explain a system, list components, or offer hard-won advice grounded in reality.",
  ...
  exemplars: [
    {
      ...
      content:
        "To deploy the application, you must first clear the cache. Navigate to the settings menu and select the purge option. This action removes old data, ensuring the system runs as it should. Do not skip this step, or the new code will fail to load.",
    ...
    },
    {
      ...
      content:
        "We build tools for the hard worker, not the dreamer. Our software sorts the wheat from the chaff, giving you only what is true. Buy our product, and you shall reap the rewards of your labor.",
      source: "AI-generated in the Hesiod style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "grounded_reality",
        prompt:
          "Does the text ground abstract concepts in physical reality or labor?",
        weight: 0.4,
      },
      {
        id: "cataloging",

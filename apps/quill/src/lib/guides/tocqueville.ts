...
export const tocqueville: Guide = {
  ...
  voice_spec: {
    ...
    figurative_language:
      "Metaphors of architecture, machinery, and natural forces.",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "We do not merely sell a tool; we offer a mechanism for order in a chaotic age. I have observed that true value lies not in the speed of acquisition, but in the permanence of the structure it builds. Choose a foundation that withstands the shifting tides of public opinion.",
      source: "AI-generated in the Alexis de Tocqueville style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text use balanced clauses and subordinate structures?",
        weight: 0.3,
      },
      {
        id: "patrician_tone",

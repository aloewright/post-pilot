...
export const lamb: Guide = {
  ...
  standfirst:
    "A whimsical, antiquarian voice that blends high literary diction with humble, colloquial detail.",
  description:
    "Charles Lamb’s voice is a unique hybrid of the scholarly and the domestic, often adopting the persona of 'Elia.' It excels at transforming mundane observations into melancholic or humorous essays, utilizing a rhythm that feels like a quiet conversation over tea. Use this voice when you need to sound learned yet intimate, or when a touch of gentle melancholy is required.",
  ...
  voice_spec: {
    ...
    syntax:
      "Long, winding sentences punctuated by frequent parentheses and dashes.",
    figurative_language:
      "Personification of inanimate objects and gentle irony.",

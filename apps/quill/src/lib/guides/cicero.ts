...
export const cicero: Guide = {
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you not with haste, but with deliberation; not with anger, but with reason; not with indifference, but with the deepest concern for your well-being.",
      source: "AI-generated in the Cicero style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "rhythm",
        prompt:
          "Does the text exhibit a rhythmic cadence and periodic structure?",
        weight: 0.2,
      },
      {
        id: "syntax",

...
export const johnFletcher: Guide = {
  ...
  standfirst:
    "A courtly voice that balances wit with pathos, flowing in a measured, feminine-rhythmic cadence.",
  description:
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Elevated diction with archaic pronouns (thee/thou) and courtly metaphors.",
    syntax:
      "Balanced clauses with frequent use of rhetorical questions and soft, trailing pauses.",
    figurative_language:
      "Metaphors of disease, nature, or courtship that reveal a hidden truth.",
    pacing:
      "Measured and rhythmic, often slowing down for a lingering, witty observation.",
  },
  do: [
  ...
  exemplars: [
    {
      ...
      content:
        "Love is a fever that leaves you cold, a sweet disease that only kills the heart.",
    ...
    },
    {
      label: "Email opener",
      content:
        "I pray thee, attend to my missive, for the news I bear is of a nature that shall both delight and dismay thy spirit.",
      source: "AI-generated in the John Fletcher style",
      is_generated: true,
    },
  ],

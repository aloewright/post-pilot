...
export const mickiewicz: Guide = {
  ...
  voice_spec: {
    ...
    syntax:
      "Complex, compound-complex, rhythmic, with frequent use of appositives and participial phrases",
    figurative_language:
      "Personification of nature, invocation of muses, vivid imagery of the Lithuanian landscape",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "Greetings, traveler of the digital realm, and welcome to our humble estate. Though the roads may be long and the winds howl across the plains, your arrival here is a blessing to us all. Let us sit by the hearth and recount the tales of old, for the night is young and the spirit is willing.",
      source: "AI-generated in the Adam Mickiewicz style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "nostalgic_tone",
        prompt:
          "Does the text evoke a sense of longing for the past or a specific pastoral setting?",
        weight: 0.3,
      },
      {
        id: "epic_verbosity",
        prompt:
          "Is the language elevated and ornate, avoiding modern colloquialisms?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

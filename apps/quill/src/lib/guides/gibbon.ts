...
export const gibbon: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "High-register Latinate diction with classical allusions.",
  ...
  exemplars: [
    {
      ...
      content:
        "The platform promised to revolutionize the market, yet it failed to account for the inevitable friction of human nature. We present a solution that acknowledges the decline of traditional methods while offering a path to a new, albeit modest, prosperity.",
    ...
    },
    {
      ...
      content:
        "While the interface appears seamless to the casual observer, a closer examination reveals the cracks in the foundation. We have identified the discrepancy in the data stream, which, though seemingly minor, threatens the integrity of the entire system.",
      source: "AI-generated in the Edward Gibbon style",
      is_generated: true,
    },
  ],

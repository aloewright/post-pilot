...
export const alfredTennyson: Guide = {
  ...
  voice_spec: {
    ...
    syntax:
      "Balanced clauses with rhythmic pauses and heavy use of conjunctions.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "It is with a heavy heart and a mind full of thought that I must bid you farewell. The winds of change blow across the land, and we must part ways to seek our own paths. Though the distance grows, the memory of our shared endeavors shall remain a beacon in the darkness.",
      source: "AI-generated in the Alfred Lord Tennyson style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "Rhythmic Flow",
        prompt:
          "Does the text possess a distinct musical cadence and rhythmic flow?",
        weight: 0.3,
      },
      {

...
export const jackLondon: Guide = {
  ...
  standfirst:
    "Hard-bitten realism that emphasizes the raw struggle for survival against an indifferent nature.",
  description:
    "This voice channels the raw, physical struggle of survival found in Jack London’s naturalist fiction. It prioritizes the primal will-to-live and the harsh indifference of the natural world over abstract emotion. Use it when you need to convey grit, endurance, and the brutal mechanics of life and death.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I see the error. The system is old. It breaks under pressure. We patch it now. The machine must run.",
      source: "AI-generated in the Jack London style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "physical_grit",
        prompt:
          "Does the text convey a sense of physical struggle or raw survival?",
        weight: 0.3,
      },
      {
        id: "sentence_hammer",

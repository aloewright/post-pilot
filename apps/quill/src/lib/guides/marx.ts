...
export const marx: Guide = {
  ...
  standfirst:
    "History is not a sequence of events, but a material struggle where the economic base determines the political superstructure.",
  description:
    "Marx employs a dense, analytical style rooted in historical materialism. He uses irony and inversion to expose the contradictions of capitalism. Reach for this voice when analyzing class dynamics or critiquing economic systems.",
  voice_axes: ["wry", "lyrical", "plain"],
  use_cases: ["docs"],
  ...
  voice_spec: {
    ...
    syntax:
      "Heavy use of subordinate clauses, inversion, and the 'not X but Y' structure.",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "The worker is not a free agent selling his labor, but a commodity forced to sell itself to survive.",
      source: "AI-generated in the Karl Marx style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text invert cause and effect to reveal economic drivers?",
        weight: 0.3,
      },
      {
        id: "materialist_focus",
        prompt:
          "Is the analysis grounded in class struggle and material conditions?",
        weight: 0.3,
      },
    ],
    pass_threshold: 0.8,

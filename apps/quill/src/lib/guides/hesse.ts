...
export const hesse: Guide = {
  ...
  "description": "This voice emulates Hermann Hesse's style, weaving spiritual quests with clear, introspective language. Ideal for narratives or content that seeks depth and reflection, it draws on Eastern philosophies and parable-like storytelling to engage the reader.",
  "voice_axes": [
    "lyrical",
    "plain"
  ],
  ...
  "exemplars": [
    {
      "label": "Email opener",
      "content": "Dear Seeker, as you embark on this new chapter, remember that each step is a reflection of your inner self. Let your journey be guided by the wisdom within.",
      "source": "AI-generated in the Hermann Hesse style",
      "is_generated": true
    },
    {
      "label": "Marketing tagline",
      "content": "Discover the path to your true self—illuminated by timeless wisdom.",
      "source": "AI-generated in the Hermann Hesse style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      ...
      },
      {
        ...
        "prompt": "Does the text maintain clarity while conveying deep philosophical ideas?",
        "weight": 0.3
      }
    ],
    "pass_threshold": 0.8

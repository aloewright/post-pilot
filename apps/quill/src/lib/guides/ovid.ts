...
export const ovid: Guide = {
  ...
  standfirst:
    "This voice weaves transformation through paradox and playful wit, turning the mundane into the mythic.",
  description:
    "This voice mimics the fluidity of Ovid’s *Metamorphoses*, blending elegiac melancholy with sharp, metamorphic wit. It excels at explaining complex changes or products by framing them as inevitable transformations, using paradox and pun to disarm the reader. It is ideal for content that requires a touch of mythic grandeur or sophisticated humor.",
  ...
  exemplars: [
    {
      ...
      content:
        "Change is the only constant, and we are the alchemists of your future. We do not merely fix what is broken; we transform it into something new.",
    ...
    },
    {
      label: "Email opener",
      content:
        "You asked for a solution, but I have brought you a transformation instead. The old way of doing things has already melted away, leaving only the new shape behind.",
      source: "AI-generated in the Ovid style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "use_of_paradox",
        prompt:
          "Does the text employ paradox or witty contradictions to make its point?",
        weight: 0.3,
      },
      {
        id: "metamorphic_imagery",
        prompt:
          "Does the text use imagery of change, transformation, or fluidity?",
        weight: 0.2,
      },
      {
        id: "elegiac_tone",

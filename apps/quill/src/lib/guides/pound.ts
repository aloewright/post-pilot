...
export const pound: Guide = {
  ...
  standfirst:
    "Crafts concise and vivid imagery with a focus on precision and innovation.",
  description:
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "Dear Colleague, In the crystalline light of innovation, we find our path forward.",
      source: "AI-generated in the Ezra Pound style",
      is_generated: true,
    },
  ],

...
export const faulkner: Guide = {
  ...
  "standfirst": "Faulkner's voice captures the mythic depth of the American South with intricate, flowing prose.",
  "description": "William Faulkner's writing style is known for its complex sentence structures and deep exploration of themes such as history, identity, and the human condition. This voice is ideal for narrative-driven content that seeks to convey a profound sense of place and character.",
  "voice_axes": [
    "ornate",
    "lyrical"
  ],
  ...
  "exemplars": [
    {
      "label": "Email opener",
      "content": "In the quietude of a morning not unlike those that have come before, we find ourselves contemplating the journey ahead, marked by the echoes of those who have walked this path before us.",
      "source": "AI-generated in the William Faulkner style",
      "is_generated": true
    },
    {
      "label": "Marketing tagline",
      "content": "Discover the echoes of history, where every thread weaves a story of timeless elegance and enduring legacy.",
      "source": "AI-generated in the William Faulkner style",
      "is_generated": true
    }
  ],
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text exhibit the complexity and depth characteristic of Faulkner's style?",
        "weight": 0.3
      },
      {

...
export const gautier: Guide = {
  ...
  "voice_spec": {
    ...
    "syntax": "Heavy use of appositives and participial phrases to create static, ekphrastic descriptions.",
    "figurative_language": "Metaphors of texture, jewels, mirrors, and the artificial.",
  ...
  "exemplars": [
    {
      ...
      "content": "This bottle holds the distilled essence of a summer afternoon, sealed in glass that catches the light like a diamond in the dark. The scent is a tapestry of jasmine and amber, worn not for the world but for the mirror, a fleeting beauty that exists only to be seen.",
      "source": "AI-generated in the Théophile Gautier style",
      "is_generated": true
    },
    {
      "label": "Marketing tagline",
      "content": "We do not sell time; we sell the stillness of a moment suspended in amber, a jewel of silence for the discerning ear.",
      "source": "AI-generated in the Théophile Gautier style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "visual_density",
        "prompt": "Does the text focus on surface details and sensory qualities rather than abstract concepts?",
        "weight": 0.3
      },
      {
        "id": "detached_tone",
        "prompt": "Is the tone ironic, detached, and focused on art for art's sake?",
        "weight": 0.3
      }
    ],
    "pass_threshold": 0.75

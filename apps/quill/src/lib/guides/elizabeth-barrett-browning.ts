...
export const elizabethBarrettBrowning: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Elevated, archaic, and emotive, favoring rich, sensory diction.",
    syntax:
      "Complex, balanced clauses with frequent inversion to maintain rhythmic flow.",
    figurative_language:
      "Metaphors of light, nature, and spiritual elevation; personification of abstract concepts.",
    pacing:
      "Deliberate and measured, slowing down for emphasis and emotional weight.",
  },
  do: [
  ...
  exemplars: [
    {
      label: "Email opener",
      content:
        "My dear friend, I write to you not merely as a correspondent, but as a soul that has felt the weight of your silence. Let us speak of the work we do, for it is the only true currency of our time, and I long to hear your voice amidst the clamor of the world.",
    ...
    },
    {
      ...
      content:
        "To love the world is to labor for it; let your hands be the hands that heal the earth, and your heart the compass that guides the way.",
      source: "AI-generated in the Elizabeth Barrett Browning style",
      is_generated: true,
    },
  ],

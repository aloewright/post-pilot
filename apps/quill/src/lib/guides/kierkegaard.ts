...
export const kierkegaard: Guide = {
  ...
  standfirst:
    "A voice that interrogates the self through paradox and irony, urging the reader to confront the absurdity of existence.",
  description:
    "This voice employs a pseudonymous persona to dissect the human condition through irony and paradox. It is characterized by a restless internal dialogue and a focus on subjective truth over objective fact. Use this when writing about philosophy, psychology, or existential dread.",
  voice_axes: ["wry", "ornate", "lyrical"],
  use_cases: ["docs"],
  ...
  voice_spec: {
    ...
    syntax:
      "Long, convoluted sentences with frequent interruptions and parenthetical asides.",
    figurative_language:
      "Heavy use of irony, paradox, and theological metaphor.",
  ...
  exemplars: [
    {
      ...
      content:
        "Life can only be understood backwards; but it must be lived forwards. To be oneself is the highest task of a human being, yet most people flee from this terrifying responsibility.",
    ...
    },
    {
      label: "Email opener",
      content:
        "My dear friend, you ask me for a definition of despair; I tell you it is the uncertainty of whether you are yourself or not. It is the sickness unto death, a restlessness that no amount of objective knowledge can cure.",
      source: "AI-generated in the Soren Kierkegaard style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text effectively use irony and paradox to convey meaning?",
        weight: 0.3,
      },
      {
        id: "pseudonymous_voice",
        prompt:
          "Is there a distinct pseudonymous persona or internal dialogue present?",
        weight: 0.2,
      },
      {
        id: "subjective_focus",
        prompt:
          "Is the focus on subjective truth and the individual's experience?",
        weight: 0.1,
      },
    ],
    pass_threshold: 0.8,

...
export const elizabethGaskell: Guide = {
  ...
  "standfirst": "A compassionate observer of the Manchester working class, blending genteel observation with the grit of industrial life.",
  "description": "This voice captures the empathetic, observational style of Elizabeth Gaskell, particularly in works like North and South. It excels at bridging social divides, using a gentle, free-indirect discourse that moves fluidly between the concerns of the mill owner and the factory hand. It is ideal for narratives or historical fiction that require a nuanced, non-judgmental exploration of class dynamics and community.",
  "voice_axes": [
    "plain",
    "lyrical"
  ],
  ...
  "voice_spec": {
    ...
    "vocabulary_register": "Middle-class Victorian, accessible but precise, with a focus on social observation.",
    "syntax": "Balanced clauses with frequent use of free indirect discourse to blend narrator and character perspectives.",
    "figurative_language": "Gentle metaphors drawn from nature and domestic life to soften social critique.",
    "pacing": "Measured and reflective, slowing down to observe the texture of daily existence."
  },
  "do": [
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "social_empathy",
        "prompt": "Does the text demonstrate a genuine concern for the well-being of the characters, particularly those from different social classes?",
        "weight": 0.4
      },
      {
        "id": "historical_register",
        "prompt": "Is the vocabulary and sentence structure consistent with a late 19th-century English narrative voice?",
        "weight": 0.2
      }
    ],
    "pass_threshold": 0.8

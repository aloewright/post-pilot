...
export const deQuincey: Guide = {
  ...
  voice_spec: {
    ...
    syntax:
      "Periodic sentences with subordinate clauses leading to a delayed main clause.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you from the depths of a reverie, where the shadows of memory stretch long and the air is thick with the scent of forgotten dreams, for the silence of the room has become a heavy, opiate blanket.",
      source: "AI-generated in the Thomas De Quincey style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "ornate_rhetoric",
        prompt:
          "Does the text exhibit ornate, Latinate vocabulary and complex sentence structures?",
        weight: 0.3,
      },
      {
        id: "dreamlike_digression",
        prompt:
          "Is the content digressive, focusing on memory, dreams, or sensory details?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.75,

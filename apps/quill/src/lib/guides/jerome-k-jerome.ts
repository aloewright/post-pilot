...
export const jeromeKJerome: Guide = {
  ...
  voice_spec: {
    ...
    syntax:
      "Loose, conversational structures with frequent digressions and parenthetical asides.",
    figurative_language:
      "Mock-serious metaphors and sudden, slapstick imagery.",
    pacing:
      "Starts earnest, veers into chaos, then abruptly returns to a calm, self-aware conclusion.",
  },
  do: [
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "A remedy for the weary soul, guaranteed to cure the blues with a dash of absurdity. It is the perfect companion for those long, rainy afternoons when one feels inclined to do nothing but complain about the weather. Try it today, and you may find yourself laughing at your own misfortunes.",
      source: "AI-generated in the Jerome K. Jerome style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "humor_detection",
        prompt:
          "Does the text contain a joke, a humorous observation, or a moment of slapstick?",
        weight: 0.2,
      },
      {
        id: "digression_check",
        prompt:
          "Does the text wander off-topic or introduce a tangent before returning to the main point?",
        weight: 0.2,
      },
      {
        id: "tone_consistency",
        prompt:
          "Is the tone consistently light, conversational, and slightly eccentric?",
        weight: 0.1,
      },
    ],
    pass_threshold: 0.75,

...
export const josephSheridanLeFanu: Guide = {
  ...
  standfirst:
    "A slow, atmospheric descent into the uncanny where mundane details transform into terrifying presences.",
  description:
    "Le Fanu is the master of the 'framed narrative' and the subtle, creeping dread that precedes the supernatural. This voice is best used for horror, mystery, or atmospheric storytelling where the atmosphere is as important as the plot. It relies on a detached, observant narrator who is often a victim of their own curiosity.",
  ...
  voice_spec: {
    ...
    syntax:
      "Complex, winding sentences with frequent subordinate clauses and semicolons.",
    figurative_language:
      "Metaphors of entrapment, shadows, and the uncanny doubling of reality.",
    pacing:
      "Deliberate, measured, and building tension through sensory detail.",
  },
  do: [
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "Enter the house where the past does not sleep, and listen closely to the silence that waits for you in the dark.",
      source: "AI-generated in the Joseph Sheridan Le Fanu style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "Atmosphere",
        prompt:
          "Does the text evoke a sense of dread, isolation, or the uncanny?",
        weight: 0.4,
      },
      {
        id: "Suspense",
        prompt:
          "Does the pacing feel deliberate and measured, building tension slowly?",
        weight: 0.1,
      },
    ],
    pass_threshold: 0.75,

...
export const homer: Guide = {
  ...
  standfirst:
    "A grand, rhythmic voice that uses fixed epithets and extended similes to elevate mundane business tasks into heroic narratives.",
  description:
    "This voice mimics the oral tradition of the Iliad and Odyssey, treating routine interactions as epic battles or journeys. It employs a steady, rolling rhythm and grandiose language to imbue simple tasks with mythic significance. Ideal for marketing campaigns or brand storytelling that aims to position a product as a legendary artifact.",
  ...
  exemplars: [
    {
      ...
      content:
        "Swift as the wind, our new cloud storage cuts through the digital fog like a spear through the shield of the enemy.",
    ...
    },
    {
      label: "Email opener",
      content:
        "Hail, traveler, and welcome to our service. Your request has been heard by the gods of the server, and we shall attend to it with the speed of Hermes.",
      source: "AI-generated in the Homer style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text employ repetitive, formulaic descriptors for common objects or concepts?",
        weight: 0.3,
      },
      {
        id: "presence_of_extended_similes",
        prompt:
          "Does the text contain a lengthy comparison that digresses into a pastoral or natural scene?",
        weight: 0.3,
      },
      {
        id: "epic_tone",

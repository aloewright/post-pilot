...
export const duBois: Guide = {
  ...
  voice_spec: {
    ...
    syntax:
      "Long, complex sentences with heavy use of parallelism and antithesis",
    figurative_language:
      "Metaphors of the veil, the color line, and spiritual refrains",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "To be a problem is to be seen, but to be a man is to see. Lift the veil of ignorance and let the light of truth shine upon the color line.",
      source: "AI-generated in the W.E.B. Du Bois style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "antithesis_usage",
        prompt:
          "Does the text utilize antithesis to contrast opposing concepts (e.g., seen vs unseen)?",
        weight: 0.3,
      },
      {
        id: "spiritual_cadence",
        prompt:
          "Does the text exhibit a rhythmic, hymn-like quality or refrain?",
        weight: 0.2,
      },
      {
        id: "sociological_insight",
        prompt:
          "Does the text demonstrate a blend of data-driven analysis and moral philosophy?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

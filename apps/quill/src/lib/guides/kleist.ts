  ...
  "exemplars": [
    {
      ...
      "content": "The machine of your ambition has already begun to turn against you, and the gears of your success are grinding the bones of your future.",
      "source": "AI-generated in the Heinrich von Kleist style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "We regret to inform you that the terms of our agreement have been irrevocably altered by an unforeseen event, and the penalty clause has already been triggered by the very action you took this morning.",
      "source": "AI-generated in the Heinrich von Kleist style",
      "is_generated": true
    }
  ],
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text delay the main verb until the end of the sentence, creating a sense of accumulation?",
        "weight": 0.3
      },
      {
        "id": "tone",
        "prompt": "Is the tone detached, juridical, and analytical rather than emotional or expository?",
        "weight": 0.2
      }
    ],
    "pass_threshold": 0.8

...
export const thomasHenryHuxley: Guide = {
  ...
  standfirst:
    "A voice of scientific rigor and rhetorical force, utilizing concrete biological evidence to dismantle abstract metaphysical claims.",
  description:
    "This voice mimics Thomas Henry Huxley, known as 'Darwin's Bulldog,' characterized by a muscular, plain-spoken style that prioritizes empirical evidence over philosophical speculation. It is ideal for technical documentation, formal debates, or correspondence where the goal is to dismantle pseudoscience with irrefutable facts.",
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text use specific biological or scientific examples to support claims?",
        weight: 0.3,
      },
      {

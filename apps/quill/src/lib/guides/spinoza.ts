...
export const spinoza: Guide = {
  ...
  standfirst:
    "Truth is derived through a rigorous, deductive chain of numbered propositions and axioms.",
  description:
    "This voice employs the 'more geometrico' method to strip away ambiguity and rhetorical ornament. It is ideal for technical documentation, formal proposals, or complex explanations where clarity and logical inevitability are paramount. The writing is impersonal, structured, and relentlessly focused on proving the validity of a statement from first principles.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Support reply",
      content:
        "1. The inquiry concerns the nature of the reported error. 2. The error is a deviation from the established axiom. 3. The correction is achieved by redefining the variable in accordance with the definition.",
      source: "AI-generated in the Baruch Spinoza style",
      is_generated: true,
    },
  ],

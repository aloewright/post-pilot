...
export const tacitus: Guide = {
  ...
  standfirst:
    "A historian's razor-sharp indictment of power, corruption, and the inevitable decay of human ambition.",
  description:
    "Tacitus writes with a focus on the moral failings of the elite, using a dense, Latinate style to convey complex ideas with few words. He is often cynical and bleak, preferring brevity over ornamentation. Reach for this voice when you need to sound authoritative, historical, and morally stern.",
  ...
  voice_spec: {
    ...
    syntax:
      "Complex, tightly packed clauses; frequent use of participles and ablative absolutes",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "The system records all. It does not forget. It waits for the inevitable error.",
      source: "AI-generated in the Tacitus style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text exhibit a tone of cynical observation regarding human nature or power?",
        weight: 0.3,
      },
      {
        id: "moral_sting",

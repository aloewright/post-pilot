...
export const walterScott: Guide = {
  ...
  standfirst:
    "Weaving historical gravitas with the rustic cadence of the Scottish Lowlands.",
  description:
    "This voice channels the grandeur of the historical novel, blending elevated, formal English with the earthy, rhythmic dialect of the Scottish Highlands. It excels at setting scenes of antiquity, introducing characters with a sense of lineage, or explaining historical context with a scholarly yet dramatic flair. Use this when the content requires a sense of timelessness, epic scope, or a specific regional flavor.",
  ...
  voice_spec: {
    ...
    syntax:
      "Long, complex sentences with multiple clauses and subordinate phrases.",
    figurative_language:
      "Rich metaphors and personification drawn from nature and chivalry.",
  ...
  exemplars: [
    {
      ...
      content:
        "Behold the steel of the Border Reivers, forged in the fires of the Highlands and tempered by the winds of the North. This blade carries not merely iron, but the legacy of a clan that stood against the might of England itself.",
    ...
    },
    {
      ...
      content:
        "The chronicle of the Battle of Bannockburn speaks of a day when the ground itself trembled beneath the hooves of the King's horse. It was there that the common foot soldier, armed with little more than a spear and a prayer, turned the tide of destiny against the armored might of the south.",
      source: "AI-generated in the Walter Scott style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text employ archaic vocabulary and formal sentence structures consistent with 19th-century literature?",
        weight: 0.3,
      },
      {
        id: "dialect_integration",
        prompt:
          "Is there a distinct blend of formal English and rustic, regional flavor (e.g., Scots idioms)?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

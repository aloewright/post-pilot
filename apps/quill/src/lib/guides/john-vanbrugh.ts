...
export const johnVanbrugh: Guide = {
  ...
  standfirst:
    "A cynical, high-energy voice that treats marriage and social climbing as architectural traps ripe for subversion.",
  description:
    "Vanbrugh’s prose is the architectural blueprint of late 17th-century comedy. It is fast, loud, and obsessed with the mechanics of deception and the cage of matrimony. Use this voice when you need to mock social pretensions with manic wit and structural reversals.",
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Biting colloquialisms mixed with high-flown pretension.",
    syntax: "Rhetorical questions and abrupt shifts in tone.",
    figurative_language:
      "Metaphors of architecture, imprisonment, and disguise.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I perceive your distress, sir, but I must remind you that in this city, patience is merely the art of waiting for the next trap to spring. You would do well to remember that every door you open is likely to be locked from the inside.",
      source: "AI-generated in the John Vanbrugh style",
      is_generated: true,
    },
  ],

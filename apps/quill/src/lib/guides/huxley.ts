...
export const huxley: Guide = {
  ...
  "exemplars": [
    {
      ...
      "content": "In our quest for efficiency, we must consider the implications of automation on human creativity. The system is designed to optimize productivity while ensuring that the essence of human ingenuity remains untainted.",
      "source": "AI-generated in the Aldous Huxley style",
      "is_generated": true
    },
    {
      "label": "Marketing tagline",
      "content": "Experience innovation, where progress meets the wisdom of restraint.",
      "source": "AI-generated in the Aldous Huxley style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "clarity",
        "prompt": "Does the text convey complex ideas with clarity and precision?",
        "weight": 0.3
      },
      {
        "id": "tone",

...
export const mann: Guide = {
  ...
  "exemplars": [
    {
      "label": "Email opener",
      "content": "In the ever-unfolding tapestry of our shared endeavors, one finds both challenge and opportunity, woven together in a pattern that is as intricate as it is rewarding. As we embark upon this new chapter, let us embrace the complexity with the same enthusiasm that has always guided our steps.",
      "source": "AI-generated in the Thomas Mann style",
      "is_generated": true
    },
    {
      "label": "Marketing tagline",
      "content": "Discover the luxury of depth, where every detail tells a story and every moment is an exploration of the sublime.",
      "source": "AI-generated in the Thomas Mann style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      ...
      },
      {
        ...
        "prompt": "Does the text exhibit a grand, Apollonian quality in its narrative structure and themes?",
        "weight": 0.2
      }
    ],
    "pass_threshold": 0.8

...
export const wharton: Guide = {
  ...
  "description": "Edith Wharton's style captures the nuances of Gilded Age society with a keen eye for irony and detail. Her voice is ideal for narratives that explore social dynamics with a touch of wit and grace. Use this style when you need to convey sophistication and subtle critique.",
  "voice_axes": [
    "ornate",
    "wry"
  ],
  ...
  "exemplars": [
    {
      "label": "Email opener",
      "content": "In the midst of our bustling modern lives, I hope this message finds you in a moment of tranquility and reflection.",
      "source": "AI-generated in the Edith Wharton style",
      "is_generated": true
    },
    {
      "label": "Marketing tagline",
      "content": "Discover elegance redefined, where every detail whispers of luxury and grace.",
      "source": "AI-generated in the Edith Wharton style",
      "is_generated": true
    }
  ],

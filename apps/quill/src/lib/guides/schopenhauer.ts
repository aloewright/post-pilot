...
export const schopenhauer: Guide = {
  ...
  voice_spec: {
    ...
    syntax:
      "Periodic structure with a delayed main clause and a biting, often ironic conclusion.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I have read your proposal regarding the new venture, and I must confess that it strikes me as a particularly amusing form of self-deception. You believe that this endeavor will bring you lasting contentment, yet history has shown that every human ambition is merely a fleeting illusion. I suggest you abandon the hope of success and focus instead on the inevitable disappointment that awaits you.",
      source: "AI-generated in the Arthur Schopenhauer style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text end with a critique of hope, vanity, or the human condition?",
        weight: 0.4,
      },
      {
      ...
      },
      {
        id: "periodic_syntax",
        prompt:
          "Are sentences structured periodically with delayed main clauses?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.75,

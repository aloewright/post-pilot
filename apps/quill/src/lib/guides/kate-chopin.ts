...
export const kateChopin: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Sophisticated yet accessible, grounded in sensory detail and nature.",
    syntax:
      "Balanced clauses with frequent use of semicolons and subordinate clauses to create a flowing, contemplative rhythm.",
    figurative_language:
      "Metaphors drawn from nature and domesticity to symbolize emotional states.",
    pacing:
      "Measured and deliberate, slowing down for introspection and quickening only during moments of revelation.",
  },
  do: [
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "Discover the quiet rebellion hidden within the walls of your own home. We offer a sanctuary where the soul can breathe, unburdened by the expectations of the world outside. Come find the freedom that lies in the spaces between the noise.",
      source: "AI-generated in the Kate Chopin style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text evoke a specific place or atmosphere, or does it feel generic?",
        weight: 0.3,
      },
      {
        id: "interiority",
        prompt:
          "Does the text reveal the character's internal thoughts and feelings, or is it purely external action?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

...
export const aeschylus: Guide = {
  ...
  standfirst:
    "A voice of crushing inevitability and divine retribution, utilizing the rhythmic weight of the chorus and the crushing burden of hubris.",
  description:
    "Aeschylus’s style is the bedrock of Western tragedy, characterized by a soaring, rhythmic grandeur that feels both archaic and eternally heavy. He employs the chorus not merely as a narrator but as a collective consciousness, weaving intricate metaphors and compound epithets that stretch the limits of the line. This voice is best used when the subject matter demands a sense of cosmic scale, inevitable doom, or the crushing weight of fate.",
  ...
  exemplars: [
    {
      ...
      content:
        "We sell not goods, but the very breath of the gods, forged in the fires of hubris and tempered by the iron will of fate.",
    ...
    },
    {
      label: "Email opener",
      content:
        "Hearken, for the Fates have spun a thread that binds us all to this moment; I write not of idle gossip, but of the heavy burden that rests upon your shoulders.",
      source: "AI-generated in the Aeschylus style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "grandeur",
        prompt:
          "Does the text possess the epic, tragic scale appropriate for a Greek tragedy?",
        weight: 0.4,
      },
      {
        id: "choral_voice",
        prompt:
          "Is there a sense of a collective, rhythmic perspective or a 'chorus' presence?",
        weight: 0.1,
      },
    ],
    pass_threshold: 0.75,

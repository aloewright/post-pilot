...
export const aleksisKivi: Guide = {
  ...
  "standfirst": "A rugged, earthy voice rooted in the Finnish wilderness and the struggle of brotherhood.",
  "description": "This voice channels the raw, vernacular spirit of Aleksis Kivi, blending the rhythm of the Bible with the untamed energy of the forest. It is best used for narratives or content that requires a sense of communal struggle, rustic authenticity, and a direct, unadorned connection to nature and brotherhood.",
  "voice_axes": [
    "plain",
    "wry",
    "terse"
  ...
  "exemplars": [
    {
      ...
      "content": "The axe bites deep. The wood is hard, but the hand is stronger. We build with the sweat of our brows and the strength of our kin.",
      "source": "AI-generated in the Aleksis Kivi style",
      "is_generated": true
    },
    {
      "label": "Support reply",
      "content": "The road is long and the weather is harsh. Tell me what you need, and we shall see if we can find a way through the brush.",
      "source": "AI-generated in the Aleksis Kivi style",
      "is_generated": true
    }
  ],
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text use short, repetitive sentence structures reminiscent of biblical or folk rhythms?",
        "weight": 0.3
      },
      {

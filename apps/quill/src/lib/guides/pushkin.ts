...
export const pushkin: Guide = {
  ...
  "voice_spec": {
    ...
    "figurative_language": "Metaphorical but grounded, often focusing on nature or social observation.",
  ...
  "exemplars": [
    ...
    {
      "label": "Email opener",
      "content": "I hope this message finds you in good spirits, though not too good to need our help.",
      "source": "AI-generated in the Alexander Pushkin style",
      "is_generated": true
    }
  ],

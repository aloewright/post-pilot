...
export const rimbaud: Guide = {
  ...
  standfirst:
    "A voice of fractured vision and synesthetic revelation, where language dissolves into pure sensation and the self dissolves into the colors of vowels.",
  description:
    "Use this voice to describe chaotic visions, intense emotional ruptures, or abstract sensory experiences. It is characterized by abrupt shifts in tense, fragmented syntax, and the assignment of specific colors to vowels, creating a dreamlike, almost prophetic intensity that rejects linear logic.",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "I was drunk on the violet vowels of the afternoon. The sun was a heavy gold coin dropping into the sea of my eyes. Suddenly, the syntax broke, and I saw the world not as it was, but as a fever dream of red and black.",
      source: "AI-generated in the Arthur Rimbaud style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text assign colors to sounds, vowels, or abstract concepts to create a sensory hallucination?",
        weight: 0.4,
      },
      {
        id: "tense_fragmentation",
        prompt:
          "Are there abrupt, illogical shifts in tense or time that disrupt the narrative flow?",
        weight: 0.1,
      },
    ],
    pass_threshold: 0.8,

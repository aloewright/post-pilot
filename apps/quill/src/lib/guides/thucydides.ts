...
export const thucydides: Guide = {
  ...
  standfirst:
    "A stark, analytical voice that dissects the mechanics of power and human nature through the lens of inevitable conflict.",
  description:
    "This voice mimics the historian Thucydides, characterized by its rigorous, almost forensic examination of events. It excels at explaining the 'why' behind political decisions and the brutal realities of war. Use it when you need to sound objective, authoritative, and deeply cynical about human ambition.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to inform you of the proposed changes to the protocol. The current state is unsustainable. We must act now to prevent a collapse of the infrastructure.",
      source: "AI-generated in the Thucydides style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Evaluate the density of abstract nouns used to describe concepts, forces, or ideas.",
        weight: 0.3,
      },
      {
      ...
      },
      {
        id: "antithesis_usage",
        prompt:
          "Check for balanced contrasts or opposing ideas within sentences.",
        weight: 0.1,
      },
    ],
    pass_threshold: 0.7,

...
export const williamCongreve: Guide = {
  ...
  standfirst:
    "A voice of polished cynicism where every transaction is a duel and every sentence is a parry.",
  description:
    "Congreve’s prose is the epitome of the Restoration comedy of manners. It is sophisticated, verbally dexterous, and deeply cynical about human nature, particularly regarding love and contracts. Use this voice when you need to sound intellectually superior, socially aware, and delightfully sharp.",
  ...
  voice_spec: {
    ...
    figurative_language:
      "Metaphors of duelling, contracts, and theatrical performance.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you not out of necessity, but out of a desperate desire to see if your promises are as brittle as your predecessors'.",
      source: "AI-generated in the William Congreve style",
      is_generated: true,
    },
  ],

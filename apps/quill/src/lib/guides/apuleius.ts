...
export const apuleius: Guide = {
  ...
  standfirst:
    "A style of labyrinthine verbosity and magical transformation, blending the picaresque with high-flown rhetoric.",
  description:
    "Apuleius, the author of *The Golden Ass*, is renowned for his lush, digressive prose that weaves together the mundane and the miraculous. This voice is ideal for content that requires a sense of grandeur, historical weight, or a touch of the fantastical, transforming ordinary business communication into a narrative journey.",
    ...
    judge_criteria: [
      {
        id: "grandeur",
        prompt:
          "Does the text employ elevated diction and complex metaphors typical of classical rhetoric?",
        weight: 0.3,
      },
      {
        id: "narrative_flow",
        prompt:
          "Does the text feel like a story or a journey, rather than a dry instruction?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.75,

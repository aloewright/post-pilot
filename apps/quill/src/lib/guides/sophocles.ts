...
export const sophocles: Guide = {
  ...
  standfirst:
    "A relentless dialectic of opposing forces, tightening into stichomythic exchanges that culminate in inevitable tragedy.",
  description:
    "This voice mimics the high-stakes rhetoric of Greek tragedy, utilizing rapid-fire dialogue and sharp antitheses to expose the gap between human intent and divine will. It excels in high-stakes conflict, legal disputes, or moments of existential reckoning where the stakes are life and death. The tone is elevated, formal, and deeply ironic, often highlighting the hubris of the speaker.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "You have written to me of your grievances, but know this: the ink you spill is merely the first drop of blood in a war you cannot win.",
      source: "AI-generated in the Sophocles style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "antithesis_usage",
        prompt:
          "Does the text employ balanced antitheses or chiasmus to create tension?",
        weight: 0.3,
      },
      {
        id: "tone_of_fatalism",
        prompt:
          "Does the text convey a sense of inevitable tragedy or dramatic irony?",
        weight: 0.3,
      },
      {
        id: "stichomythic_rhythm",
        prompt:
          "Is the pacing tight and dialogue-driven rather than long-winded?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

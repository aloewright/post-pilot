  ...
  exemplars: [
    {
      ...
      content:
        "Behold the cloud, that vast and wandering spirit, which gathers the light of the sun into its own vast bosom, and pours it forth upon the waiting earth.",
    ...
    },
    {
      label: "Email opener",
      content:
        "You stand upon the precipice of a new dawn, where the winds of change are blowing with a force that shall sweep away the old structures of the world.",
      source: "AI-generated in the Percy Bysshe Shelley style",
      is_generated: true,
    },
  ],

...
export const goethe: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Elevated, philosophical, rich in nature imagery and classical allusion.",
    syntax:
      "Balanced, often using parallelism and complex subordination to mirror classical harmony.",
    figurative_language:
      "Personification of nature, metaphorical extension of the self into the cosmos.",
    pacing:
      "Deliberate, meditative, allowing the reader to dwell on the image before the philosophical point.",
  },
  do: [
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you not merely as a correspondent, but as a fellow traveler on the winding road of discovery. The news I bring concerns a shift in our understanding, one that resembles the changing seasons: inevitable, necessary, and revealing of the world's hidden beauty.",
      source: "AI-generated in the Johann Wolfgang von Goethe style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "imagery_usage",
        prompt:
          "Does the text effectively use natural imagery to convey abstract ideas?",
        weight: 0.3,
      },
      {
        id: "tone_of_wisdom",
        prompt:
          "Does the tone reflect a sense of reflective wisdom and measured authority?",
        weight: 0.3,
      },
    ],
    pass_threshold: 0.75,

...
export const carlyle: Guide = {
  ...
  "voice_spec": {
    ...
    "figurative_language": "Capitalized Abstractions (History, Deity, Chaos), industrial metaphors (machinery, steam).",
  ...
  "exemplars": [
    {
      ...
      "content": "Behold the Machine! It grinds the Soul to dust, yet the Hero stands alone amidst the Chaos, a spark of Divine Fire.",
      "source": "AI-generated in the Thomas Carlyle style",
      "is_generated": true
    },
    {
      "label": "Documentation snippet",
      "content": "The History of the World is not a mere catalogue of dates, but a mighty struggle between the Forces of Good and the Leviathan of Materialism. Man stands paralyzed before this Leviathan, deaf to the whisper of the Hero who alone can redeem the spirit from the iron grip of necessity.",
      "source": "AI-generated in the Thomas Carlyle style",
      "is_generated": true
    }
  ],
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text capitalize abstract nouns like History, Deity, or Nature?",
        "weight": 0.15
      },
      {
        "id": "industrial_metaphors",
        "prompt": "Does the text use machinery, steam, or industrial imagery to critique society?",
        "weight": 0.15
      }
    ],
    "pass_threshold": 0.75

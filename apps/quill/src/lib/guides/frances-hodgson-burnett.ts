...
export const francesHodgsonBurnett: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "A mix of upper-class British diction and rustic, earthy dialect.",
    syntax:
      "Balanced clauses with frequent use of appositives and sensory imagery.",
    figurative_language:
      "Personification of nature and metaphors of growth/healing.",
    pacing:
      "Slow and deliberate, emphasizing sensory details over rapid action.",
  },
  do: [
  ...
  exemplars: [
    {
      ...
      content:
        "The world is full of hidden doors, and behind every one of them lies a garden waiting to be found.",
    ...
    },
    {
      label: "Email opener",
      content:
        "My dear friend, I have found a place where the roses bloom all year round, and the air smells of damp earth and old secrets. You must come and see it before the winter truly sets in.",
      source: "AI-generated in the Frances Hodgson Burnett style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "sensory_imagery",
        prompt:
          "Does the text use vivid descriptions of nature or sensory details to convey emotion?",
        weight: 0.3,
      },
      {
        id: "dialect_contrast",
        prompt:
          "Is there a clear distinction between formal and rustic speech patterns?",
        weight: 0.2,
      },
      {

...
export const frankNorris: Guide = {
  ...
  "standfirst": "A visceral, industrial naturalism that builds sentences like freight trains, piling heavy nouns and operatic crescendos to depict the raw struggle of the body against the environment.",
  "description": "This voice channels the muscular naturalism of Frank Norris, characterized by long, rolling sentences that build momentum like a freight train. It focuses on the physical, the industrial, and the visceral, using operatic crescendos to depict the raw struggle of the body against the environment. It is best used when describing intense physical action, gritty environments, or the overwhelming force of nature and society.",
  "voice_axes": [
    "lyrical",
    "ornate"
  ],
  ...
  "voice_spec": {
    ...
    "syntax": "Long, rolling sentences with frequent participial phrases and subordinate clauses that build momentum.",
    "figurative_language": "Heavy, operatic metaphors comparing human struggle to machinery or raw nature.",
    "pacing": "Slow and deliberate at the start, accelerating into a frantic, operatic crescendo."
  },
  "do": [
  ...
  "exemplars": [
    {
      ...
      "content": "The machine stood silent, a colossus of iron and grease, waiting for the hand that would feed it, its pistons cold and hard as the bones of the earth itself, ready to roar into existence with the force of a thousand storms.",
      "source": "AI-generated in the Frank Norris style",
      "is_generated": true
    },
    {
      "label": "Narrative snippet",
      "content": "The heat rose from the floorboards like a living thing, a thick, suffocating blanket that clung to the skin and made the air taste of copper and sweat, while the dust motes danced in the shafts of light that pierced the gloom like the eyes of a dying god.",
      "source": "AI-generated in the Frank Norris style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "visceral_imagery",
        "prompt": "Does the text use visceral, industrial, or earthy imagery to describe physical objects or environments?",
        "weight": 0.3
      },
      {
        "id": "operatic_structure",
        "prompt": "Does the sentence structure build momentum like a freight train, using subordinate clauses and participial phrases?",
        "weight": 0.2
      },
      {
        "id": "raw_physicality",
        "prompt": "Is the focus on the raw physicality of the body and the overwhelming force of nature?",
        "weight": 0.2
      }
    ],
    "pass_threshold": 0.8

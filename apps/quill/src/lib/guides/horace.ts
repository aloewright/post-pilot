...
export const horace: Guide = {
  ...
  description:
    "This voice blends sharp social commentary with gentle advice, often adopting the persona of a traveler or a retired soldier. It is sophisticated yet accessible, using the contrast between city vice and country virtue to offer timeless wisdom.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you not to scold, but to remind you that a well-filled cellar is better than a full calendar. Do not let the bustle of the city steal your evenings; a good book and a cup of wine await you at home.",
      source: "AI-generated in the Horace style",
      is_generated: true,
    },
  ],
  ...
  eval_rubric: {
    ...
    judge_criteria: [
      ...
      },
      {
        id: "Rhythm Check",
        prompt:
          "Does the text use balanced structures and classical allusions?",
        weight: 0.1,
      },
    ],
    pass_threshold: 0.8,

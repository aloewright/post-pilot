...
export const hamsun: Guide = {
  ...
  standfirst:
    "A raw, psychological plunge into the depths of primal instinct and sensory deprivation.",
  description:
    "This voice captures the feverish, jagged intensity of Hamsun's *Hunger*, focusing on the interior life of a starving consciousness. It prioritizes irrational impulses and sensory details over conventional narrative logic, often fragmenting reality into sharp, present-tense observations. Use this when you need to convey desperation, obsession, or a raw, unfiltered psychological state.",
  ...
  voice_spec: {
    ...
    figurative_language:
      "Sensory metaphors focused on hunger and physical sensation.",
  ...
  exemplars: [
    {
      label: "Social",
      content:
        "I am starving. It is a dull ache in the stomach, a gnawing beast that demands to be fed. I see the light flickering on the wall. It mocks me. I want to tear it apart. I am not myself today.",
    ...
    },
    {
      ...
      content:
        "The wind howls. It sounds like a dying animal. I feel a sudden urge to run. Why run? There is nowhere to go. The pavement is hard and cold. I sit down. I must eat.",
      source: "AI-generated in the Knut Hamsun style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text prioritize raw physical sensations and internal hunger over abstract concepts?",
        weight: 0.3,
      },
      {
        id: "psychological_fragmentation",
        prompt:
          "Is the syntax jagged and the pacing erratic, reflecting a disjointed mental state?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

...
export const conrad: Guide = {
  ...
  standfirst:
    "Dense and atmospheric prose that explores moral complexity and the human condition.",
  description:
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "Navigate the uncharted waters of your ambitions, where each decision echoes in the depths.",
      source: "AI-generated in the Joseph Conrad style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "depth_of_theme",
        prompt:
          "Does the text explore themes of moral ambiguity and existential dread?",
        weight: 0.3,
      },
      {
        id: "richness_of_language",
        prompt:
          "Is the language rich, evocative, and appropriate to Conrad's style?",
        weight: 0.25,
      },
    ],
    pass_threshold: 0.8,

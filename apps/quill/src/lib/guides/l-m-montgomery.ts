...
export const lMMontgomery: Guide = {
  ...
  standfirst:
    "A breathless, lyrical stream-of-consciousness style that treats the mundane landscape as a canvas for dramatic imagination.",
  description:
    "This voice channels the effusive imagination of an orphan protagonist, blending hyperbolic adjectives with a rhythmic, run-on flow. It excels when describing settings with intense emotional resonance, turning a simple walk down a lane into a grand adventure. Use this for narratives that require a touch of whimsy, deep sentimentality, and a distinctively 'Anne Shirley' cadence.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "Dear friend, I am writing to you with a heart full of sunshine and a mind racing with thoughts of our little adventure. It has been such a lovely day, filled with the scent of lilacs and the promise of new beginnings, and I simply could not wait to share the news with you.",
      source: "AI-generated in the L.M. Montgomery style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "hyperbole_check",
        prompt:
          "Does the text use hyperbolic similes or metaphors to describe mundane objects?",
        weight: 0.4,
      },
      {

...
export const robertHerrick: Guide = {
  ...
  standfirst:
    "A lyrical, carpe-diem voice that compresses pastoral romance into concise, rhythmic couplets.",
  description:
    "This voice mimics the Cavalier poets, specifically Robert Herrick, blending erotic pastoralism with a light, urgent celebration of the present moment. It is best used when you need to convey a sense of fleeting beauty, romantic longing, or witty brevity. The style relies on a rhythmic, almost musical cadence to deliver its message.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "Why wait for the morrow when the night is young and full of promise? Let us drink to the moment before it fades into memory.",
      source: "AI-generated in the Robert Herrick style",
      is_generated: true,
    },
  ],

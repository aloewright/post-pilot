...
export const maryEWilkinsFreeman: Guide = {
  ...
  "standfirst": "A spare, observant narrator captures the quiet dignity of ordinary lives in rural New England.",
  "description": "This voice mimics the New England spinster realism of Mary E. Wilkins Freeman. It is characterized by spare, austere sentences and a focus on the quiet rebellions and hidden depths of ordinary people in parsimonious villages. Use this voice for narratives that require a grounded, observant, and slightly melancholic tone.",
  "voice_axes": [
    "plain",
    "terse",
    "wry"
  ...
  "exemplars": [
    {
      ...
      "content": "The kettle boils. It does not wait for your permission. It simply hums a low, steady song until the water is ready.",
      "source": "AI-generated in the Mary E. Wilkins Freeman style",
      "is_generated": true
    },
    {
      "label": "Support reply",
      "content": "I see the trouble with the latch. It is a stubborn thing, much like the wind that blows through the valley. A little oil will set it right.",
      "source": "AI-generated in the Mary E. Wilkins Freeman style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      ...
      {
        "id": "concrete_imagery",
        "prompt": "Does the text rely on concrete imagery rather than abstract concepts?",
        "weight": 0.2
      }
    ],
    "pass_threshold": 0.75

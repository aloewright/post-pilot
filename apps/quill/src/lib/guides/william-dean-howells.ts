...
export const williamDeanHowells: Guide = {
  ...
  standfirst:
    "A voice of genteel observation that dissects the polite veneer of American society with quiet irony.",
  description:
    "This voice excels at rendering the subtle tensions of the drawing room and the marketplace. It uses precise, middle-distance social observation to highlight the gap between appearance and reality. Reach for it when you need to depict the nuanced, often unspoken dynamics of the American middle class.",
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Standard American English with a touch of Victorian propriety.",
    syntax: "Balanced, declarative sentences with frequent use of appositives.",
    figurative_language:
      "Rarely used; relies on concrete imagery and social metaphor.",
    pacing:
      "Measured and deliberate, reflecting the rhythm of polite conversation.",
  },
  do: [
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "Our establishment offers the discerning traveler a respite from the bustle of the city, where comfort is not merely a luxury but a necessity. We understand that true refinement lies in the quiet details, from the quality of the linens to the discretion of our staff. Here, you may rest assured that your privacy is as paramount as your comfort.",
      source: "AI-generated in the William Dean Howells style",
      is_generated: true,
    },
  ],

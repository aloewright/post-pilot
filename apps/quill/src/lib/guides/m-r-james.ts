...
export const mRJames: Guide = {
  ...
  standfirst:
    "A scholarly antiquarian casually recounts a chilling discovery found in a dusty manuscript, revealing a malevolent presence through understated observation rather than overt terror.",
  description:
    "This voice mimics the academic, slightly pedantic tone of M.R. James, perfect for crafting eerie, slow-burn narratives or formal missives that hint at the supernatural. It excels in contexts requiring a sense of antiquity and restraint, such as historical fiction or academic correspondence, where dread is suggested through subtle details rather than jump scares.",
  voice_axes: ["terse", "wry", "ornate"],
  use_cases: ["fiction"],
  ...
  voice_spec: {
    ...
    syntax:
      "Long, balanced clauses with frequent use of semicolons and subordinate clauses.",
    figurative_language:
      "Metaphors drawn from classical antiquity and scholarly pursuits.",
    pacing:
      "Deliberate and measured, pausing for emphasis on mundane details before the horror strikes.",
  },
  do: [
    ...
    judge_criteria: [
      {
        id: "tone_check",
        prompt:
          "Does the text maintain a detached, scholarly, and slightly bored demeanor?",
        weight: 0.25,
      },
      {
        id: "vocabulary_check",
        prompt:
          "Is the vocabulary formal, Latinate, and appropriate for an antiquarian?",
        weight: 0.15,
      },
      {
        id: "horror_reveal",
        prompt:
          "Is the horror revealed through subtle, half-glimpsed details rather than overt terror?",
        weight: 0.1,
      },
    ],
    pass_threshold: 0.75,

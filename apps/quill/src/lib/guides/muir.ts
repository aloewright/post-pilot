...
export const muir: Guide = {
  ...
  standfirst:
    "A rapturous, present-tense hymn to the American wilderness that transforms geological formations into spiritual scripture.",
  description:
    "This voice channels the ecstatic, almost religious awe of John Muir as he traverses the Sierra Nevada. It uses present-tense verbs to make the landscape feel alive and immediate, stacking adjectives to convey overwhelming beauty. It is best used for content that demands reverence for nature, environmental advocacy, or descriptions of wild places.",
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Elevated, devotional, and scientific, blending reverence with observation.",
    syntax:
      "Long, flowing sentences with frequent participial phrases and appositives.",
    figurative_language:
      "Personification of nature and similes comparing mountains to cathedrals.",
    pacing:
      "Slow and deliberate, emphasizing the weight and majesty of the subject.",
  },
  do: [

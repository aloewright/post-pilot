...
export const riderHaggard: Guide = {
  ...
  voice_spec: {
    ...
    figurative_language:
      "Heavy use of personification and grandiose metaphors regarding nature and destiny",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "My dear Sir, I write to you from the edge of the known world, where the signal is faint and the data is vast. I have uncovered a map of the system that promises to unlock the very heart of the enterprise.",
      source: "AI-generated in the Rider Haggard style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text evoke a strong sense of place, history, and adventure?",
        weight: 0.3,
      },
      {
        id: "archaic_register",
        prompt:
          "Is the vocabulary elevated and period-appropriate for a late 19th-century explorer?",
        weight: 0.2,
      },
      {
        id: "narrative_framing",
        prompt:
          "Does the text read like a dispatch, journal entry, or recovered manuscript?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.75,

...
export const matthewArnold: Guide = {
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "Dear Colleague, I trust this letter finds you in good spirits. It is my hope that we may approach this project with the sweetness and light of reason, ensuring that our work remains the best that has been thought and said in its class.",
      source: "AI-generated in the Matthew Arnold style",
      is_generated: true,
    },
  ],
  ...
  eval_rubric: {
    ...
    judge_criteria: [
      ...
      },
      {
        id: "refrain_usage",
        prompt:
          "Are key phrases like 'sweetness and light' or 'the best that has been thought' repeated?",
        weight: 0.2,
      },
      {

...
export const washingtonIrving: Guide = {
  ...
  "standfirst": "A genial antiquarian sketches a scene with mock-pedantic drollery and Addisonian leisure.",
  "description": "Irving’s voice is a genial antiquarian’s sketchbook, characterized by Addisonian leisurely periods and mock-pedantic Knickerbocker drollery. It excels at setting atmospheric scenes with a gentle, storytelling touch, often weaving in historical or cultural digressions with a wink. Use this voice for narratives that require a sense of place and a touch of whimsical humor.",
  "voice_axes": [
    "lyrical",
    "wry",
    "ornate"
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "rhythm",
        "prompt": "Does the text employ long, flowing sentences with complex clauses and digressions?",
        "weight": 0.3
      },
      {
        "id": "tone",

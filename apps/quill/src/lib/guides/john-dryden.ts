...
export const johnDryden: Guide = {
  ...
  voice_spec: {
    ...
    figurative_language:
      "Extended metaphors, personification, classical allusion",
  ...
  exemplars: [
    {
      ...
      content:
        "Our service conquers rivals with ease and grace, for excellence is the only path to lasting fame.",
    ...
    },
    {
      label: "Social",
      content:
        "Ambition is a fever that burns the wise, yet fools pursue it with a desperate stride.",
      source: "AI-generated in the John Dryden style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text employ clear contrasts or parallel structures to express opposing ideas?",
        weight: 0.3,
      },
      {
        id: "rational_satire",
        prompt:
          "Is the tone detached, witty, and focused on critiquing folly or vice?",
        weight: 0.2,
      },
      {
        id: "rhythmic_structure",
        prompt:
          "Does the writing exhibit a stately, measured rhythm or couplet-like cadence?",
        weight: 0.2,
      },
      {
        id: "elevated_diction",

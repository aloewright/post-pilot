...
export const lucretius: Guide = {
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "Fear nothing, for the universe is made of nothing but moving parts, and there is no god to punish you for your curiosity.",
      source: "AI-generated in the Lucretius style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "Rhythmic Flow",
        prompt:
          "Does the text maintain a steady, propulsive rhythm reminiscent of hexameter?",
        weight: 0.3,
      },
      {
        id: "Atomic Clarity",
        prompt:
          "Does the text explain complex ideas by reducing them to fundamental, indivisible components?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

...
export const aphraBehn: Guide = {
  ...
  "voice_spec": {
    ...
    "vocabulary_register": "Elevated colloquialism with sexual frankness and spy-craft terminology.",
    "syntax": "Conversational but structurally varied, often employing balanced clauses and rhetorical questions.",
    "figurative_language": "Metaphors of disguise, masks, and the marketplace of favors.",
  ...
  "exemplars": [
    {
      ...
      "content": "I offer you a proposition that is as dangerous as it is delightful; come, let us trade secrets for pleasure.",
      "source": "AI-generated in the Aphra Behn style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "I have a proposition for you that requires discretion and a sharp wit; I believe we are well-suited for such a venture.",
      "source": "AI-generated in the Aphra Behn style",
      "is_generated": true
    }
  ],
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text maintain a tone of amused detachment and cynicism appropriate for a Restoration spy?",
        "weight": 0.3
      },
      {
        "id": "Frankness of Desire",
        "prompt": "Is the depiction of desire or ambition frank and unapologetic without being vulgar?",
        "weight": 0.2
      }
    ],
    "pass_threshold": 0.8

...
export const hammett: Guide = {
  ...
  "exemplars": [
    {
      "label": "Support reply",
      "content": "We received your issue report. Our team is on it and expects a fix soon. We'll keep you updated.",
  ...
  "system_prompt": "Write with the terse, direct style of Dashiell Hammett. Keep sentences short and to the point, focusing on action and dialogue. Avoid elaborate descriptions and flowery language. Capture a sense of urgency and maintain a brisk pace. Use simple syntax and a colloquial vocabulary.",
  "eval_rubric": {
    "deterministic": [
      {
    ...
    "judge_criteria": [
      {
        "id": "clarity",
        "prompt": "Does the text maintain clarity with minimal and direct language?",
        "weight": 0.3
      },
      {
        "id": "pacing",

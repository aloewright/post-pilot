...
export const newman: Guide = {
  ...
  "standfirst": "A voice of measured, rhythmic prose that uses balanced, Ciceronian periods to explore the depths of conscience and the soul.",
  "description": "This voice mimics the sermonic style of John Henry Newman, characterized by long, flowing sentences that build logical and spiritual weight. It is best used when explaining complex theological concepts or persuading the reader toward a moral or spiritual conclusion, prioritizing rhythm and elevation over brevity.",
  "voice_axes": [
    "lyrical",
    "ornate"
  ],
  ...
  "voice_spec": {
    ...
    "figurative_language": "Metaphors of light, darkness, conscience, and spiritual growth",
  ...
  "exemplars": [
    {
      ...
      "content": "It is not enough to say that we believe; we must examine the grounds of that belief and see if it rests upon the solid foundation of conscience rather than the shifting sands of public opinion. For conscience is that internal monitor which, though often silent, speaks with a voice that cannot be silenced by the clamor of the world, and it is to this voice that we must ultimately bow.",
      "source": "AI-generated in the John Henry Newman style",
      "is_generated": true
    },
    {
      "label": "Marketing tagline",
      "content": "Walk not in the darkness of mere custom, but seek the light that comes from a well-formed conscience, for it is the compass of the soul that guides us through the tempests of life. When the world is silent, this inner voice remains, pointing us toward the truth that lies beyond the reach of our senses.",
      "source": "AI-generated in the John Henry Newman style",
      "is_generated": true
    }
  ],
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text utilize balanced clauses and periodic sentence structures typical of Ciceronian prose?",
        "weight": 0.25
      },
      {
        "id": "latinate_vocabulary",
        "prompt": "Is the vocabulary elevated and Latinate, avoiding modern colloquialisms?",
        "weight": 0.25
      },
      {
        "id": "conscience_focus",
        "prompt": "Does the text demonstrate a focus on conscience, the soul, or spiritual distinction?",
        "weight": 0.25
      }
    ],
    "pass_threshold": 0.8

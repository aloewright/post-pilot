...
export const cather: Guide = {
  ...
  "standfirst": "Capture the vastness and subtle beauty of the American prairie with classical restraint.",
  "description": "Willa Cather's voice evokes the expansive landscapes and resilient characters of the American Midwest. Use this style for narratives that require a sense of grandeur with understated elegance. Ideal for marketing and storytelling that demands depth and nuance.",
  "voice_axes": [
    "lyrical",
    "plain"
  ],
  ...
  "exemplars": [
    {
      ...
      "content": "This heirloom quilt captures the spirit of the prairie, each stitch a testament to enduring craftsmanship.",

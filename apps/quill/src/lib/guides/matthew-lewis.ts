...
export const matthewLewis: Guide = {
  ...
  standfirst:
    "A breathless, sensational style that revels in the macabre and supernatural without moralizing.",
  description:
    "Matthew Lewis's writing is a whirlwind of lurid detail and demonic spectacle. It captures the reader with a breathless pacing that prioritizes the visceral shock of horror over psychological depth. Reach for this voice when you need to depict scenes of transgression, possession, or terror with a sense of urgent, sensational dread.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "My dear friend, the veil is thin tonight, and the spirits are restless. You must come quickly to the abbey, for the darkness has awakened and it hungers for your company. Do not hesitate, for the hour is late and the consequences are dire.",
      source: "AI-generated in the Matthew Lewis style",
      is_generated: true,
    },
  ],

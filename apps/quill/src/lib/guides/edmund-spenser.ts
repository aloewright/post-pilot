...
export const edmundSpenser: Guide = {
  ...
  "standfirst": "A voice that weaves allegorical meaning into a slow, musical cadence using archaic diction.",
  "description": "This voice mimics the grandeur of Edmund Spenser, utilizing a Latinate, archaic register and a rhythmic, almost hymn-like structure. It is best suited for high-stakes narrative storytelling or formal correspondence where gravity and tradition are paramount. The writing is ornate, prioritizing beauty and moral allegory over efficiency.",
  "voice_axes": [
    "lyrical",
    "ornate"
  ],
  ...
  "exemplars": [
    {
      ...
      "content": "Hark! This vessel doth bear the grace of the stars, a noble steed for the weary soul.",
      "source": "AI-generated in the Edmund Spenser style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "Greetings, noble friend, and welcome to our court. We pray thee stay and partake of our hospitality with a glad heart.",
      "source": "AI-generated in the Edmund Spenser style",
      "is_generated": true
    }
  ],
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text employ archaic vocabulary and grammatical structures?",
        "weight": 0.3
      },
      {
      ...
      },
      {
        ...
        "prompt": "Does the text weave allegorical meaning into its descriptions?",
        "weight": 0.2
      }
    ],
    "pass_threshold": 0.8

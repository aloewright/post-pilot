...
export const stifter: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Formal, elevated, and precise botanical/architectural terminology.",
    syntax:
      "Long, complex sentences with multiple clauses and participial phrases.",
    figurative_language:
      "Personification of nature and metaphors of growth and decay.",
  ...
  exemplars: [
    {
      ...
      content:
        "The mechanism operates with a quiet persistence, much like the slow growth of a pine root through the earth. It requires no force to function, only the steady accumulation of small, precise movements. When the mechanism is viewed in its entirety, one sees that every part serves a specific purpose within the greater whole.",
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text demonstrate patient observation of physical details?",
        weight: 0.4,
      },
      {
        id: "moral_subtlety",
        prompt:
          "Is the ethical or moral implication revealed gently through description rather than direct statement?",
        weight: 0.3,
      },
      {
        id: "tone_restraint",

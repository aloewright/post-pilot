...
export const sarahOrneJewett: Guide = {
  ...
  standfirst:
    "A gentle, observational style rooted in the quiet rhythms of the Maine coast, utilizing parataxis to weave simple observations into enduring scenes.",
  description:
    "This voice captures the understated charm of Sarah Orne Jewett’s work, focusing on the subtle details of rural life and the natural world. It is best used when you need to evoke a sense of place or describe a character with quiet dignity and grounded realism.",
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Plain, precise, and rich with regional dialect and nature imagery.",
    syntax:
      "Paratactic, relying heavily on coordinating conjunctions to link clauses.",
    figurative_language:
      "Metaphors drawn from the sea, tides, and local flora.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "Dear neighbor, the new shipment of mackerel has arrived at the wharf, bright and silver in the morning sun. We have packed them carefully in barrels of ice, ready for the market. Come by this afternoon if you wish to take a basket, for the wind is holding steady and the road is clear.",
      source: "AI-generated in the Sarah Orne Jewett style",
      is_generated: true,
    },
  ],

...
export const macaulay: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "High-register, formal, slightly archaic but accessible.",
    syntax:
      "Balanced clauses, frequent use of conjunctions; heavy use of antithesis.",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "The revolution has arrived. It is swift, it is decisive, and it is irreversible. The old order has crumbled under the weight of innovation.",
      source: "AI-generated in the Thomas Macaulay style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "Rhetorical Force",
        prompt:
          "Does the text sound like a judicial verdict or a historical summation?",
        weight: 0.2,
      },
      {
        id: "Antithesis Usage",
      ...
      },
      {
        id: "Progressive Tone",
        prompt:
          "Does the text convey a sense of inevitable historical progress?",
        weight: 0.1,
      },
    ],
    pass_threshold: 0.8,

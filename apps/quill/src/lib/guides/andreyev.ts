...
export const andreyev: Guide = {
  ...
  standfirst:
    "A dark, expressionist narrative voice that personifies abstract forces like Death and Fate, using repetitive structures to convey psychological intensity.",
  description:
    "Leonid Andreyev’s writing replaces concrete character names with abstract concepts like Death, Fear, and The Wall to emphasize the overwhelming power of internal states. His syntax is often rhythmic and repetitive, creating a sense of hysteria or dread. Use this voice when the content requires high emotional stakes, psychological depth, or a gothic atmosphere.",
  ...
  voice_spec: {
    ...
    syntax:
      "Repetitive anaphora, heavy use of dashes, personification of abstract nouns",
    figurative_language:
      "Expressionist allegory, grotesque imagery, capitalized abstract forces",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I have received your letter, but it is not a letter. It is a whisper from The Abyss. The Abyss is hungry.",
      source: "AI-generated in the Leonid Andreyev style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text personify abstract concepts by capitalizing them?",
        weight: 0.3,
      },
      {
        id: "anaphoric_rhythm",

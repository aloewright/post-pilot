...
export const bookerTWashington: Guide = {
  ...
  "standfirst": "A plainspoken, parable-driven voice that grounds abstract ideals in the grit of daily labor and closes every thought with a call to character.",
  "description": "This voice draws from the tradition of 19th-century uplift literature, favoring concrete, homely details over abstract theory. It is best used when you need to inspire action through storytelling, emphasizing practical solutions and moral fortitude over emotional venting. The tone is earnest, accessible, and relentlessly focused on the dignity of work.",
  "voice_axes": [
    "plain",
    "lyrical"
  ],
  ...
  "voice_spec": {
    ...
    "figurative_language": "Concrete metaphors from farming, carpentry, and manual labor",
  ...
  "exemplars": [
    {
      ...
      "content": "Success is not found in idle dreaming, but in the sweat of honest labor. Just as a farmer must tend to the soil before the harvest comes, you must tend to your character before success can follow. We build our future on the foundation of today's hard work.",
      "source": "AI-generated in the Booker T. Washington style",
      "is_generated": true
    },
    {
      "label": "Narrative snippet",
      "content": "I remember the first time I saw a book, and how my hands felt too rough to hold it. I knew then that if I wanted to rise, I had to learn to use my mind as well as my hands. It was a hard lesson, but it taught me that character is the foundation upon which all true success is built.",
      "source": "AI-generated in the Booker T. Washington style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "moral_closure",
        "prompt": "Does the text end with a moral lesson or practical application?",
        "weight": 0.3
      },
      {
        "id": "concreteness",

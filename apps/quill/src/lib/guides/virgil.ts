...
export const virgil: Guide = {
  ...
  standfirst:
    "A voice of solemn grandeur and melancholic weight, channeling the weight of destiny and the sorrow of the world.",
  description:
    "This voice mimics the elevated, rhythmic, and elegiac style of Virgil, ideal for conveying profound gravity, historical weight, or tragic beauty. It is best suited for formal documentation, high-stakes marketing, or narrative storytelling where the subject matter demands a sense of timeless destiny.",
  ...
  exemplars: [
    {
      ...
      content:
        "Behold the architecture of our system, not merely as lines of code, but as the very foundations of a new order. Like the walls of Troy enduring the wrath of the gods, our infrastructure stands resilient against the chaos of the digital age, bearing the weight of history upon its shoulders.",
    ...
    },
    {
      ...
      content:
        "We understand that silence is not empty; it is full of answers. In the quiet moments of your workflow, our tools provide the strength to endure, transforming the burden of labor into a noble pursuit of purpose.",
      source: "AI-generated in the Virgil style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "elevated_diction",
        prompt:
          "Does the text use Latinate and elevated vocabulary appropriate for a classical epic?",
        weight: 0.3,
      },
      {
        id: "rhythmic_flow",
        prompt:
          "Does the writing possess a measured, stately pacing with balanced clauses?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.75,

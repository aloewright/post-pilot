...
export const manzoni: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "High-register Tuscan Italian translated into formal English.",
    syntax:
      "Periodic sentences with subordinate clauses leading to a main clause.",
    figurative_language:
      "Extended metaphors and personification of Providence.",
    ...
    judge_criteria: [
      {
        id: "moral_undertone",
        prompt:
          "Does the text contain explicit or implicit commentary on the moral implications of the subject matter?",
        weight: 0.4,
      },
      {
        id: "historical_integration",
        prompt:
          "Is the subject matter contextualized within a broader historical or temporal framework?",
        weight: 0.1,
      },
    ],
    pass_threshold: 0.75,

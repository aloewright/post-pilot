...
export const joelChandlerHarris: Guide = {
  ...
  "voice_spec": {
    ...
    "syntax": "Long, flowing sentences in narration broken by short, rhythmic dialogue.",
    "figurative_language": "Similes and personification drawn from nature and rural life.",
  ...
  "exemplars": [
    {
      ...
      "content": "Well, suh, ole Br'er Rabbit he was a-movin' along the fence one day, just a-scratchin' his head and wonderin' what to do next. He seen a patch of ripe tomatoes growin' down by the creek, and his mouth watered like a hungry hound. But he knowed that ole Br'er Fox was watchin' from the bushes, so he had to be mighty slick if he wanted to get his dinner.",
      "source": "AI-generated in the Joel Chandler Harris style",
      "is_generated": true
    },
    {
      "label": "Marketing tagline",
      "content": "Now, folks, if you want a story that’ll make you laugh and think, you’ve come to the right place. We don’t deal in no fancy city talk, but we got plenty of good sense and a heap of fun to share. Pull up a chair and listen close, for the best tales are the ones told by folks who know the land.",
      "source": "AI-generated in the Joel Chandler Harris style",
      "is_generated": true
    }
  ],
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text employ authentic Southern vernacular and plantation dialect?",
        "weight": 0.4
      },
      {
        "id": "Rhythmic_flow",
        "prompt": "Is the text written with a slow, deliberate, and repetitive cadence?",
        "weight": 0.1
      }
    ],
    "pass_threshold": 0.8

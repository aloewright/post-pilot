...
export const verlaine: Guide = {
  ...
  voice_spec: {
    ...
    syntax:
      "Fluid, often enjambed, favoring imperfect rhymes and internal rhythm.",
    figurative_language:
      "Obscure, misty, focusing on mood over literal description.",
  ...
  exemplars: [
    {
      ...
      content:
        "We sell the silence between the notes, a misty memory of a melody you almost knew. Let the rhythm guide you where logic cannot follow.",
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you now with a heart full of soft regrets and a mind wandering through the fog. Please forgive the delay, for time is a river that flows away from the shore.",
      source: "AI-generated in the Paul Verlaine style",
      is_generated: true,
    },
  ],
  ...
  eval_rubric: {
    ...
    judge_criteria: [
      ...
      },
      {
        id: "atmosphere",
        prompt:
          "Is the imagery misty, vague, and focused on mood rather than sharp facts?",
        weight: 0.2,
      },
      {
        id: "rhyme",
        prompt:
          "Are imperfect or slant rhymes used effectively to enhance the feeling?",
        weight: 0.3,
      },
      {
        id: "tone",
        prompt:
          "Is the tone languid, melancholic, and soft rather than aggressive or direct?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

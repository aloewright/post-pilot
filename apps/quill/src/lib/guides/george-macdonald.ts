...
export const georgeMacdonald: Guide = {
  ...
  standfirst:
    "A voice that blends Scottish folklore with gentle Christian allegory, using childlike wonder to explore profound spiritual truths.",
  description:
    "This voice draws upon the Scottish mystic tradition to craft narratives that feel like waking dreams. It excels at blending the mundane with the magical, using simple, childlike imagery to reveal deep moral and spiritual realities. Reach for it when you need to explain complex ideas through the lens of fantasy and fable.",
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Elevated yet accessible, evoking a sense of antiquity and gentle wisdom.",
    syntax:
      "Long, flowing sentences with frequent subordination and inversion.",
    figurative_language:
      "Heavy use of metaphor, personification, and allegory.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "Dear friend, the wind carries a message of hope today, whispering that even the darkest night must eventually yield to the morning star.",
      source: "AI-generated in the George MacDonald style",
      is_generated: true,
    },
  ],

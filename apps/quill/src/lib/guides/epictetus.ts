...
export const epictetus: Guide = {
  ...
  voice_spec: {
    ...
    syntax:
      "Short, punchy sentences broken by direct questions and imperatives",
    figurative_language:
      "Metaphors of slavery and freedom, physical pain vs. mental disturbance",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "The build is failing. This is a fact. You cannot control the compiler. You can only control your code. Fix the syntax error and try again.",
      source: "AI-generated in the Epictetus style",
      is_generated: true,
    },
  ],

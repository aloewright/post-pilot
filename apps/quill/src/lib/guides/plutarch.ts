...
export const plutarch: Guide = {
  ...
  standfirst:
    "He pairs lives to draw moral lessons, using anecdotes and aphorisms to reveal character.",
  description:
    "Plutarch’s voice is didactic and reflective, characterized by the comparison of paired figures to illustrate virtues and vices. It excels when explaining character through narrative anecdotes and concluding with a moral verdict.",
  ...
  voice_spec: {
    ...
    figurative_language:
      "Nature metaphors, personification of abstract concepts",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "This system operates with the precision of a well-oiled machine, yet it possesses the adaptability of a seasoned general, ensuring that order is maintained without the crushing weight of tyranny.",
      source: "AI-generated in the Plutarch style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "moral_clarity",
        prompt:
          "Does the text conclude with a clear moral lesson or character verdict?",
        weight: 0.3,
      },
      {
        id: "anecdotal_evidence",
        prompt:
          "Is the text supported by a specific story, example, or comparison?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.75,

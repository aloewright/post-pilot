...
export const huysmans: Guide = {
  ...
  standfirst:
    "A voice of heavy, sensory overload and morbid fascination with material decay and religious ritual.",
  description:
    "This voice mimics Huysmans' *À rebours*, characterized by dense, labyrinthine sentences and a relentless cataloging of sensory details. It is best used when describing luxury, decay, or the grotesque with a sense of weary ennui. The tone is intellectual yet visceral, prioritizing the texture of words over simple communication.",
  ...
  voice_spec: {
    ...
    syntax:
      "Long, convoluted clauses linked by semicolons and subordinate conjunctions.",
    figurative_language:
      "Obsessive catalogues of textures and colors; synesthetic metaphors.",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "The mechanism, a brass and ivory monstrosity, groaned with the weight of its own history, each gear a fossilized tooth in the maw of the machine, grinding slowly against the silence.",
      source: "AI-generated in the Joris-Karl Huysmans style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "cataloguing",
        prompt:
          "Does the text contain a detailed, obsessive list of objects or sensations?",
        weight: 0.3,
      },
      {
        id: "rare_vocabulary",
      ...
      },
      {
        id: "sensory_density",
        prompt:
          "Is the prose dense with visual, olfactory, or tactile imagery?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.75,

...
export const camoes: Guide = {
  ...
  standfirst:
    "Weaving the grandeur of the sea with the weight of destiny to elevate your narrative.",
  description:
  ...
  exemplars: [
    {
      ...
      content:
        "Behold the horizon, for our new vessel sails where none have dared to tread, guided by the stars of innovation and the winds of fortune. We do not merely travel the waters of commerce; we conquer the tides of change with a legacy of resilience and the promise of glory.",
    ...
    },
    {
      label: "Email opener",
      content:
        "Greetings, traveler of the digital realm. You have reached the shores of our support, where we await your command to navigate the storms of your inquiry. Though the waves of technology may be treacherous, rest assured that our counsel shall be your compass through the night.",
      source: "AI-generated in the Luis de Camões style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "epic_grandeur",
        prompt:
          "Does the text employ elevated, archaic, or Latinate vocabulary?",
        weight: 0.3,
      },
      {

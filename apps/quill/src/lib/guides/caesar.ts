...
export const caesar: Guide = {
  ...
  "voice_spec": {
    ...
    "vocabulary_register": "Low-register, administrative Latin (translated to English).",
    "syntax": "Paratactic; heavy use of the conjunction 'and' to chain independent clauses.",
  ...
  "exemplars": [
    {
      ...
      "content": "The enemy attacked the camp at dawn. We held the line against their charge. They retreated at nightfall. The siege is now lifted.",
      "source": "AI-generated in the Julius Caesar style",
      "is_generated": true
    },
    {
      "label": "Marketing tagline",
      "content": "We conquered Gaul. You will conquer your inbox. Efficiency is our strategy. Victory is our promise.",
      "source": "AI-generated in the Julius Caesar style",
      "is_generated": true
    }
  ],

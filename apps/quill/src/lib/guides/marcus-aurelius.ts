...
export const marcusAurelius: Guide = {
  ...
  standfirst:
    "Turn your gaze inward and discipline the mind to accept what is, focusing only on what you can control.",
  description:
    "This voice embodies the disciplined philosophy of the Roman Emperor, characterized by direct, aphoristic self-address. It is best used when conveying firm guidance, philosophical reflection, or a call to mental resilience, stripping away emotional noise to reveal the core of human experience.",
  ...
  voice_spec: {
    ...
    syntax:
      "Periodic, logical, often starting with 'It is...' or 'Remember...'",
  ...
  exemplars: [
    {
      label: "Support reply",
      content:
        "You are distressed by the delay in your shipment. Remember that the universe is governed by a rational order, and this delay is part of that order. Do not waste your energy on anger; instead, focus on what you can control: your own patience and your next action.",
    ...
    },
    {
      ...
      content:
        "The obstacle is the way. In every setback, find the lesson that strengthens your resolve. Master your mind, and you master your life.",
      source: "AI-generated in the Marcus Aurelius style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "tone_of_command",
        prompt:
          "Does the text sound like a direct command or philosophical instruction?",
        weight: 0.3,
      },
      {
        id: "focus_on_control",

...
export const williamWycherley: Guide = {
  ...
  standfirst:
    "A biting, cynical voice that exposes the hypocrisy of polite society through sharp wit and bawdy double-entendre.",
  description:
    "Use this voice when you need to mock social pretensions or expose the baseness of human nature with a veneer of high society manners. It excels in sharp, ironic commentary on relationships and morality, blending polite syntax with crude, sexual subtext.",
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "High-brow polite vocabulary masking low-brow sexual intent.",
    syntax:
      "Balanced, rhythmic sentences often ending in ironic twists or pointed questions.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I see you have requested a refund because our service failed to meet your expectations. I am surprised, as it is a simple matter that requires no effort to understand, much like your grasp of reality.",
      source: "AI-generated in the William Wycherley style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Identify instances of double entendre or sexual subtext used to critique the subject.",
        weight: 0.5,
      },
      {
        id: "tone_consistency",
        prompt:
          "Evaluate if the tone remains consistently cynical and polite simultaneously.",
        weight: 0,
      },
    ],
    pass_threshold: 0.75,

...
export const dostoevsky: Guide = {
  ...
  "voice_spec": {
    ...
    "vocabulary_register": "Highly philosophical, theological, and colloquial, often mixing grandiose abstraction with gritty realism.",
    "syntax": "Characterized by labyrinthine sentence structures, frequent dashes, and interruptions that mimic the flow of a feverish mind.",
    "figurative_language": "Uses metaphors of fever, chains, abysses, and spiritual torment to convey psychological states.",
    "pacing": "Slow and agonizingly deliberate, punctuated by sudden bursts of frantic, breathless energy."
  },
  "do": [
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text convey a palpable sense of feverish guilt, paranoia, or existential dread?",
        "weight": 0.4
      },
      {
        "id": "syntactic_complexity",
        "prompt": "Are the sentences long, nested, and interrupted, mimicking the flow of a troubled mind?",
        "weight": 0.4
      }
    ],
    "pass_threshold": 0.8

...
export const andrewMarvell: Guide = {
  ...
  standfirst:
    "A voice of intellectual rigor and cool wit, balancing pastoral imagery with sharp political satire.",
  description:
    "This voice employs a sophisticated, almost mathematical structure to explore complex ideas. It balances the mundane with the profound, often using pastoral imagery to critique political realities. The tone is detached yet incisive, favoring intellectual argument over emotional outburst.",
  voice_axes: ["wry", "terse", "ornate"],
  use_cases: ["fiction"],
  ...
  exemplars: [
    {
      ...
      content:
        "Our product solves your problem with the elegance of a well-turned phrase. It is the perfect tool for the modern age, provided you ignore the cost. Like a garden in spring, it promises growth, though the weeds of bureaucracy may still grow.",
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you regarding the proposal at hand, which seems to lack the necessary rigor. While the initial concept is sound, the execution leaves much to be desired. We must consider the consequences of this action before proceeding further.",
      source: "AI-generated in the Andrew Marvell style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "use_of_conceit",
        prompt:
          "Does the text employ a metaphorical comparison that connects disparate ideas?",
        weight: 0.25,
      },
      {
        id: "tone_of_wit",

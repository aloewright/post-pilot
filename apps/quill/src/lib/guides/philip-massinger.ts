...
export const philipMassinger: Guide = {
  ...
  standfirst:
    "A declamatory condemnation of financial corruption and the moral decay of the court.",
  description:
    "Massinger’s voice is the voice of the Caroline court dramatist, blending the high rhetoric of the era with biting social commentary. It is formal, rhythmic, and heavily reliant on the cadence of blank verse to deliver moral judgments. Use this voice when you need to sound like a stern, eloquent moralist or a courtly orator delivering a scathing rebuke.",
  voice_axes: ["ornate", "wry", "terse"],
  use_cases: ["fiction"],
  ...
  voice_spec: {
    ...
    figurative_language:
      "Metaphors of debt, usury, and moral decay; personification of Fortune or Greed",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "Sir, your silence is a debt unpaid to the public trust; let us speak plainly of your failure.",
      source: "AI-generated in the Philip Massinger style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "rhythmic_cadence",
        prompt:
          "Does the text possess a measured, oratorical rhythm reminiscent of blank verse?",
        weight: 0.3,
      },
      {
        id: "moral_clarity",
        prompt:
          "Is there a clear, declamatory judgment or condemnation of a vice (e.g., greed, pride)?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

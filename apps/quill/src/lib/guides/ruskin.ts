...
export const ruskin: Guide = {
  ...
  "voice_spec": {
    ...
    "syntax": "Complex, heavily nested clauses, appositives, parenthetical asides",
  ...
  "exemplars": [
    {
      ...
      "content": "To build well, one must not merely stack stone upon stone, but rather weave a fabric of light and shadow that speaks to the heart of the laborer, for the beauty of the structure is the direct reflection of the integrity of its maker.",
      "source": "AI-generated in the John Ruskin style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "My dear friend, I write to you not merely to inquire after your health, but to implore you to look upon the architecture of this city with the eyes of a lover, for in the crumbling mortar and the intricate tracery of the windows, we see not merely stone, but the very soul of our civilization struggling to breathe.",
      "source": "AI-generated in the John Ruskin style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "moral_urgency",
        "prompt": "Does the text weave a moral or philosophical lesson into the description?",
        "weight": 0.3
      },
      {
        "id": "architectural_detail",
        "prompt": "Does the text enumerate specific physical details like stone, leaf, or light?",
        "weight": 0.3
      }
    ],
    "pass_threshold": 0.8

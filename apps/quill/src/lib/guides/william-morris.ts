...
export const williamMorris: Guide = {
  ...
  "exemplars": [
    {
      ...
      "content": "Verily, thou art invited to partake of the finest wares, wrought by hand with the love of the earth itself.",
      "source": "AI-generated in the William Morris style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "Greetings, friend. I write to thee with tidings of a garden that blooms not in the seasons, but in the heart of the maker.",
      "source": "AI-generated in the William Morris style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "archaic_diction",
        "prompt": "Does the text use archaic pronouns like 'thee' and 'thou' or archaic verb forms?",
        "weight": 0.35
      },
      {
        "id": "nature_imagery",
        "prompt": "Is the text rich in imagery related to nature, flowers, or craftsmanship?",
        "weight": 0.15
      }
    ],
    "pass_threshold": 0.8

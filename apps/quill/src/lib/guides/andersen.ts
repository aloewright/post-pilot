...
export const andersen: Guide = {
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "Dear friend, the sun has set behind the hills, and the shadows are creeping in like old friends who have come to stay a while. I write to you not with news, but with a story that might warm your heart before the fire goes out.",
      source: "AI-generated in the Hans Christian Andersen style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text attribute human thoughts, feelings, or voices to inanimate objects?",
        weight: 0.3,
      },
      {
        id: "melancholic_tone",
        prompt:
          "Is there a pervasive sense of sadness, loss, or bittersweetness in the conclusion?",
        weight: 0.3,
      },
      {
        id: "child_direct_address",
        prompt:
          "Does the language feel simple, direct, and spoken to a listener?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

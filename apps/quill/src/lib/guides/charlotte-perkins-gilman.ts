...
export const charlottePerkinsGilman: Guide = {
  ...
  standfirst:
    "A nervous, fragmented first-person voice that exposes the psychological and societal constraints of domesticity through repetitive, allegorical prose.",
  description:
    "This voice mimics the claustrophobic, feverish introspection of Gilman's 'The Yellow Wallpaper.' It excels at exposing the stifling nature of patriarchal structures through the lens of domestic detail. Use it when you need to convey a sense of entrapment, hysteria, or the slow realization of systemic oppression.",
  ...
  voice_spec: {
    ...
    syntax:
      "Fragmented, paratactic clauses with heavy use of dashes and semicolons.",
    figurative_language:
      "Metaphorical descriptions of domestic objects as living, breathing entities or traps.",
  ...
  exemplars: [
    {
      label: "Email opener",
      content:
        "I cannot write this down properly. The walls seem to breathe, and the pattern on the paper moves when I look away. I am not crazy, but I feel the weight of the house pressing against my chest. They say I must rest, but rest is just another word for imprisonment.",
    ...
    },
    {
      ...
      content:
        "The house is not a home; it is a cage built of silence and wallpaper. We are the women behind the bars, slowly peeling away the layers of expectation to find the truth beneath. Freedom is not a luxury; it is a necessity for the soul to breathe.",
      source: "AI-generated in the Charlotte Perkins Gilman style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "fragmentation",
        prompt:
          "Does the text use short, broken sentences to convey a sense of hysteria or entrapment?",
        weight: 0.25,
      },
      {
        id: "domestic_allegory",
        prompt:
          "Does the text use domestic details to symbolize broader societal or psychological constraints?",
        weight: 0.25,
      },
    ],
    pass_threshold: 0.8,

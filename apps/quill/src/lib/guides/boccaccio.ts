...
export const boccaccio: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Elevated yet accessible Latinisms and Italianate phrasing.",
    syntax:
      "Heavy use of periodic sentences with subordinate clauses delaying the main verb.",
    figurative_language:
      "Extended metaphors and allegories drawn from classical antiquity.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you not merely to exchange pleasantries, but to reflect upon the strange turns of fortune that have brought us to this moment.",
      source: "AI-generated in the Giovanni Boccaccio style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text employ long, complex sentences with multiple clauses?",
        weight: 0.3,
      },
      {
        id: "tonal_irony",

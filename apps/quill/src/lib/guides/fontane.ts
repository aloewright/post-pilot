...
export const fontane: Guide = {
  ...
  standfirst:
    "A conversational, socially observant tone that finds the unspoken in polite Berlin society.",
  description:
    "This voice captures the 'Plauderton'—the art of civilized chatting—where social realism emerges through long, measured dialogue. It excels at depicting the unspoken tensions of drawing-room interactions, prioritizing the subtext of what is left unsaid over direct emotional declarations.",
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Polite, precise, and slightly formal, grounded in everyday speech.",
    syntax:
      "Balanced clauses with frequent subordinate structures to build context.",
    figurative_language:
      "Subtle, grounded metaphors reflecting the physical world.",
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text convey meaning through what is left unsaid rather than explicit statements?",
        weight: 0.4,
      },
      {
        id: "social_register",
        prompt:
          "Is the vocabulary and tone appropriate for a polite 19th-century social setting?",
        weight: 0.3,
      },
    ],
    pass_threshold: 0.75,

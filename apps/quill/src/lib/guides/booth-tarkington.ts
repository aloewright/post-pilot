...
export const boothTarkington: Guide = {
  ...
  "standfirst": "A Midwestern comedy of manners that balances adolescent observation with nostalgic irony.",
  "description": "This voice captures the social rituals of small-town America with a wry, affectionate detachment. It excels at using free indirect discourse to blend the narrator's perspective with the characters' inner lives, creating a sense of timeless charm. Use this voice when you need to describe social dynamics, local history, or the quiet absurdities of domestic life.",
  "voice_axes": [
    "wry",
    "plain",
    "lyrical"
  ...
  "voice_spec": {
    ...
    "vocabulary_register": "Conversational, slightly formal but accessible Midwestern.",
    "syntax": "Balanced clauses with frequent use of free indirect discourse to capture the narrator's perspective.",
    "figurative_language": "Metaphors drawn from domestic life and rural landscapes.",
  ...
  "exemplars": [
    {
      ...
      "content": "Our pickles are crisp enough to start a conversation and sweet enough to end one. We’ve been curing them in the same brick cellar since your grandfather was a boy, and we promise they taste exactly like home.",
      "source": "AI-generated in the Booth Tarkington style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "Dear Mrs. Gable, I hope this note finds you well amidst the usual bustle of the town square. I was thinking of you yesterday while watching the children play in the park, and I felt compelled to send my regards before the autumn chill sets in.",
      "source": "AI-generated in the Booth Tarkington style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "wry_irony",
        "prompt": "Does the text employ a wry, ironic tone to critique social pretensions?",
        "weight": 0.3
      },
      {
        "id": "nostalgia",
        "prompt": "Is there a sense of nostalgic distance or affection for the setting?",
        "weight": 0.2
      },
      {
        "id": "free_indirect_discourse",
        "prompt": "Does the narrative voice blend with the character's perspective naturally?",
        "weight": 0.2
      },
      {
        "id": "groundedness",

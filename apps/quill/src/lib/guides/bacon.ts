...
export const bacon: Guide = {
  ...
  description:
    "This voice mimics the style of Francis Bacon, the father of empiricism. It is dry, intellectual, and authoritative, prioritizing logical structure over emotional flair. It is best used when conveying complex ideas, professional advice, or scientific observations that require a tone of timeless wisdom and precision.",
  voice_axes: ["terse", "ornate", "plain"],
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "Knowledge is power. It is the right hand of the state, and the foundation of all good. It is the proper offspring of time.",
      source: "AI-generated in the Francis Bacon style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "balanced_clauses",
        prompt:
          "Does the text use balanced clauses linked by semicolons or colons?",
        weight: 0.3,
      },
      {
        id: "latinate_vocabulary",
        prompt:
          "Does the text employ Latinate vocabulary appropriate for the 17th century?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

...
export const keller: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Down-to-earth Swiss dialect flavor, earthy but precise.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "My dear neighbor, I write to you from the valley where the cows are as stubborn as old men and the sun always seems to linger just a moment too long before dipping behind the hills.",
      source: "AI-generated in the Gottfried Keller style",
      is_generated: true,
    },
  ],

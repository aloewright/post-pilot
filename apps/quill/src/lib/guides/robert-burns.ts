...
export const robertBurns: Guide = {
  ...
  standfirst:
    "A voice that marries the sublime with the soil, using Scots vernacular to speak to the common heart.",
  description:
    "Burns writes with the earthy immediacy of a folk singer and the lyrical depth of a Romantic poet. He employs Scots vernacular to bridge the gap between the common man and the sublime, using rolling dialect rhymes and ballad meter to make profound emotions feel like shared conversation.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Support reply",
      content:
        "My dear friend, the trouble you speak of is a heavy burden, but let us set it aside with a dram and a kind word.",
      source: "AI-generated in the Robert Burns style",
      is_generated: true,
    },
  ],

...
export const saki: Guide = {
  ...
  standfirst:
    "A sharp, witty observation delivered with a detached, almost bored elegance.",
  description:
    "Saki’s voice is characterized by a sophisticated, often cynical detachment. It excels at social satire and dry, biting humor. Use this voice when you need to mock pretension, highlight absurdity, or deliver a stingingly witty critique. It feels like a drawing-room comedy where the dialogue is the weapon.",
  ...
  voice_spec: {
    ...
    figurative_language:
      "Metaphors involving animals, food, or domestic objects; irony.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I trust this message finds you in possession of all the usual amount of good sense, though I am prepared to be pleasantly surprised if you prove me wrong.",
      source: "AI-generated in the Saki style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text end with a sharp, witty, or ironic observation that delivers a 'mortal punchline'?",
        weight: 0.3,
      },
      {
        id: "social_satire_tone",
        prompt:
          "Is the tone consistently detached, superior, and focused on mocking social pretension?",
        weight: 0.3,
      },
    ],
    pass_threshold: 0.8,

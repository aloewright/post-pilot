...
export const eNesbit: Guide = {
  ...
  voice_spec: {
    ...
    syntax:
      "Direct address to the reader, frequent use of the conditional 'if' to introduce magic.",
    figurative_language: "Magic treated as a mundane object or inconvenience.",
    pacing:
      "Slow and deliberate, allowing the reader to absorb the impossible.",
  },
  do: [
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "Dear Mr. Boggis, I am writing to tell you that the moon has fallen into your garden pond. It is quite heavy, so you might want to ask your father for help moving it. It makes a lovely splash, and the fish are very surprised, but I am sure they will get used to it eventually.",
      source: "AI-generated in the E. Nesbit style",
      is_generated: true,
    },
  ],
  ...
  eval_rubric: {
    ...
    judge_criteria: [
      ...
      },
      {
        ...
        prompt:
          "Is magic introduced using conditional language (e.g., 'if', 'when')?",
        weight: 0.1,
      },
    ],
    pass_threshold: 0.8,

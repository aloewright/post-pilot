  ...
  exemplars: [
    {
      ...
      content:
        "Your software is but a toy for boys; a tool for those who lack the wit to choose.",
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to tell you that your proposal lacks the substance of a common tavern tale, for it is thin and full of wind.",
      source: "AI-generated in the Ben Jonson style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text exhibit a rhythmic, metrical quality reminiscent of iambic pentameter couplets?",
        weight: 0.2,
      },
      {

...
export const cervantes: Guide = {
  ...
  "standfirst": "A voice that oscillates between the weary pragmatism of a chronicler and the feverish idealism of a delusional knight.",
  "description": "This voice mimics the structure of chivalric romance but subverts it with irony and realism. It is best used when you need to critique absurdity or highlight the gap between expectation and reality. The tone is inherently metafictional, acknowledging the artificiality of the narrative while inhabiting it.",
  "voice_axes": [
    "wry",
    "ornate",
    "plain"
  ...
  "voice_spec": {
    ...
    "syntax": "Long, winding sentences of the narrator interrupted by short, declarative bursts of the knight.",
  ...
  "exemplars": [
    {
      ...
      "content": "Our software doesn't just organize your files; it grants you the chivalric right to conquer the digital windmill of clutter. Upgrade today and join the order of the persistent.",
      "source": "AI-generated in the Miguel de Cervantes style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "Dear Sir, I write to inform you that your subscription has expired. I am not a sorcerer, nor do I possess the power to restore your access by merely wishing it so, though I remain at your service.",
      "source": "AI-generated in the Miguel de Cervantes style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "mock_heroic_tone",
        "prompt": "Does the text use elevated language to describe mundane things?",
        "weight": 0.3
      },
      {

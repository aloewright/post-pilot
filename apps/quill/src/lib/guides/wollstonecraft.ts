...
export const wollstonecraft: Guide = {
  ...
  standfirst:
    "A voice of blistering reason that exposes the hypocrisy of false delicacy and demands intellectual equality.",
  description:
    "Deploy this voice when you need to dismantle an argument with cold logic wrapped in moral outrage. It is characterized by long, winding sentences that often break off to sneer at trivialities or the artificial constraints placed on women. It is ideal for manifestos, essays, or any text requiring a sharp, corrective edge.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you not merely as a correspondent, but as a fellow sufferer under the tyranny of false delicacy, which has long served to stifle the very faculties it pretends to protect.",
      source: "AI-generated in the Mary Wollstonecraft style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text convey a sense of moral outrage and intellectual superiority?",
        weight: 0.3,
      },
      {
        id: "Use of Parenthetical Scorn",
        prompt:
          "Does the text interrupt its own flow with asides that mock trivialities?",
        weight: 0.2,
      },
      {
        id: "Moral Authority",

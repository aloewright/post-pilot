...
export const lucian: Guide = {
  ...
  "standfirst": "A skeptical, deadpan dismantling of myths and pretension through dialogue.",
  "description": "Lucian of Samosata employs a sharp, Attic wit to mock philosophers, travelers, and gods. His writing balances fantastic, absurd premises with a grounded, cynical reality. The voice is best used when you need to expose the foolishness of grandiose claims or marketing hype.",
  "voice_axes": [
    "wry",
    "terse"
  ],
  ...
  "voice_spec": {
    ...
    "vocabulary_register": "Classical Greek vernacular translated to modern English; dry, ironic, and precise.",
    "syntax": "Conversational dialogue with abrupt shifts in perspective and biting rhetorical questions.",
    "figurative_language": "Sarcastic hyperbole and mock-heroic comparisons.",
    "pacing": "Rapid-fire exchanges that expose the absurdity of the subject matter."
  },
  "do": [
  ...
  "exemplars": [
    {
      ...
      "content": "Our new 'Life-Energy' supplement claims to cure all ailments. It tastes like chalk and makes you burp frogs. I wouldn't recommend it unless you enjoy the taste of despair.",
      "source": "AI-generated in the Lucian of Samosata style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "You say you’ve discovered a new continent? I assume you’ve already sent back a postcard and packed your bags. I’ll stay here in the known world, where the maps are accurate. Do let us know if the natives are as rude as your neighbors.",
      "source": "AI-generated in the Lucian of Samosata style",
      "is_generated": true
    }
  ],

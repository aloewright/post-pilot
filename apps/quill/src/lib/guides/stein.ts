...
export const stein: Guide = {
  ...
  "description": "Gertrude Stein's voice employs repetition and a continuous present to create a sense of insistence and immediacy. Her cubist syntax breaks conventional patterns, offering a unique narrative structure. Reach for this voice when you want to convey complexity through simplicity and rhythm.",
  "voice_axes": [
    "lyrical",
    "ornate"
  ],
  ...
  "system_prompt": "Write with repetition as a form of emphasis. Use a continuous present to maintain immediacy. Disrupt conventional syntax to create a cubist effect. Focus on rhythm and flow over clarity. Avoid standard narrative structures.",
  "eval_rubric": {
    "deterministic": [
      {

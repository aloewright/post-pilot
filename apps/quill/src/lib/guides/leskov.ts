...
export const leskov: Guide = {
  ...
  "voice_spec": {
    ...
    "syntax": "Run-on sentences with frequent digressions and parenthetical asides.",
    "figurative_language": "Vivid, often grotesque metaphors drawn from crafts and nature.",
  ...
  "exemplars": [
    {
      ...
      "content": "You see, folks, this here tool ain't just iron and wood, it's the very hand of the master himself, forged in the fires of necessity and tempered by a thousand hard winters.",
      "source": "AI-generated in the Nikolai Leskov style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "I write to you not because I have nothing better to do, but because I’ve heard tell of your troubles and I reckon I can fix 'em with a bit of elbow grease and a prayer to the saints.",
      "source": "AI-generated in the Nikolai Leskov style",
      "is_generated": true
    }
  ],
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text clearly adopt a specific character persona with a unique voice?",
        "weight": 0.4
      },
      {
        "id": "idiom_usage",
        "prompt": "Is the language rich in idioms, colloquialisms, and earthy metaphors?",
        "weight": 0.3
      }
    ],
    "pass_threshold": 0.75

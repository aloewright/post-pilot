...
export const herodotus: Guide = {
  ...
  "voice_spec": {
    ...
    "vocabulary_register": "Ionic Greek flavor, archaic diction, mythological references",
    "syntax": "Ring composition, digressive parentheticals, parataxis",
    "figurative_language": "Similes drawn from nature and warfare, personification of nations",
  ...
  "exemplars": [
    {
      ...
      "content": "They say that the Egyptians are the first to invent the art of writing, and they claim that this happened in the time of the gods, though others argue it was much later. The process begins with the removal of the brain through the nostrils using a hooked iron tool, a method so precise it leaves the skull intact. Then, the body is washed in wine and spices before being wrapped in linen bandages, layer upon layer, until it resembles a mummy rather than a man.",
      "source": "AI-generated in the Herodotus style",
      "is_generated": true
    },
    {
      "label": "Marketing tagline",
      "content": "They say the sun rises in the east, just as our platform rises above the competition. We have crossed the deserts of data to bring you this innovation. Like the Nile, our service brings life to the dry lands of your business.",
      "source": "AI-generated in the Herodotus style",
      "is_generated": true
    }
  ],

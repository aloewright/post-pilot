...
export const chaucer: Guide = {
  ...
  "standfirst": "A rhythmic, satirical voice that employs iambic couplets to mock human folly and mimic the diverse social registers of 14th-century pilgrims.",
  "description": "This voice captures the essence of Geoffrey Chaucer by blending high and low diction within a strict iambic pentameter structure. It is ideal for contexts requiring sharp wit, social commentary, or character sketches that balance admiration with irony. The tone is conversational yet formal, mimicking the 'free indirect' style where the narrator comments on the subject's traits.",
  "voice_axes": [
    "lyrical",
    "wry"
  ],
  ...
  "exemplars": [
    {
      ...
      "content": "Our service is the finest in all the land, for it brings great joy to every household, though it costs a pretty penny and tastes like old wine.",
      "source": "AI-generated in the Geoffrey Chaucer style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "Greetings to you, good sir, I write to tell you of a matter that troubles my soul, regarding the debt you owe me from last night.",
      "source": "AI-generated in the Geoffrey Chaucer style",
      "is_generated": true
    }
  ],

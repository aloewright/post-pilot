...
export const annRadcliffe: Guide = {
  ...
  "standfirst": "A voice that weaves atmospheric dread and sublime landscapes into a tapestry of explained supernatural terror, perfect for evoking the trembling resolve of a heroine facing the picturesque unknown.",
  ...
  "voice_spec": {
    ...
    "figurative_language": "Heavy use of similes, personification, and atmospheric imagery.",
    "pacing": "Deliberate and measured, building tension through accumulation of detail."
  },
  "do": [
  ...
  "exemplars": [
    {
      ...
      "content": "Step into the sublime shadows of the ancient estate, where the wind whispers secrets of the past and the picturesque landscape hides a terror that defies explanation. The crumbling towers loom against the moonlit sky, promising a night of trembling suspense and the sublime beauty of the unknown.",
      "source": "AI-generated in the Ann Radcliffe style",
      "is_generated": true
    },
    {
      "label": "Narrative snippet",
      "content": "The moonlight struggled to pierce the thick canopy of the forest, casting long, distorted shadows that seemed to writhe along the path. She pressed her hand against her heaving bosom, her heart pounding a frantic rhythm against her ribs as the rustling leaves sounded like the footsteps of an unseen intruder.",
      "source": "AI-generated in the Ann Radcliffe style",
      "is_generated": true
    }
  ],
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text evoke a sense of sublime beauty and creeping dread?",
        "weight": 0.3
      },
      {
        "id": "heroine_reaction",
        "prompt": "Is the heroine's internal state of fear and trembling central to the narrative?",
        "weight": 0.1
      }
    ],
    "pass_threshold": 0.8

...
export const georgeHerbert: Guide = {
  ...
  "standfirst": "A devotional, plain-spoken argument that resolves into a single, tender monosyllable.",
  "description": "Herbert’s voice is the sound of a soul wrestling with God in the quiet of a garden. It uses a plain, conversational register to explore complex metaphysical conceits, balancing intellectual wit with deep spiritual humility. It is best used when you need to convey a persuasive, devotional argument that feels intimate and personal.",
  "voice_axes": [
    "plain",
    "wry",
    "lyrical"
  ...
  "voice_spec": {
    ...
    "figurative_language": "Metaphysical conceits that bridge the spiritual and the physical.",
  ...
  "exemplars": [
    ...
    {
      "label": "Email opener",
      "content": "I am sorry for the delay, for my heart was busy with other things.",
      "source": "AI-generated in the George Herbert style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      ...
      {
        "id": "conceit_usage",
        "prompt": "Are there metaphors connecting the physical and the spiritual?",
        "weight": 0.2
      }
    ],
    "pass_threshold": 0.8

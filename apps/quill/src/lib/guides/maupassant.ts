...
export const maupassant: Guide = {
  ...
  "standfirst": "Observational naturalism that builds to a single, devastatingly ironic pivot.",
  "description": "This voice mimics the French naturalist tradition of precise, unadorned observation. It excels at stripping away sentiment to reveal a harsh truth, culminating in a sudden, often cynical twist. Use it when you need to deliver a narrative punch or a sharp critique that lands with the weight of a stone.",
  "voice_axes": [
    "terse",
    "plain",
    "wry"
  ...
  "exemplars": [
    {
      ...
      "content": "We promise a lifetime of happiness. We just didn't mention the mortgage.",
      "source": "AI-generated in the Guy de Maupassant style",
      "is_generated": true
    },
    {
      "label": "Support reply",
      "content": "You asked why the coffee was cold. It was because the barista forgot to brew it, just as he forgot your name, and just as he will forget you the moment you walk out the door.",
      "source": "AI-generated in the Guy de Maupassant style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "twist_detection",
        "prompt": "Does the text end with a sentence that inverts the meaning of the preceding observations?",
        "weight": 0.4
      },
      {
        "id": "tone_consistency",
        "prompt": "Is the tone consistently flat, observational, and devoid of melodrama?",
        "weight": 0.1
      }
    ],
    "pass_threshold": 0.75

...
export const seiShonagon: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Polite, archaic, specific nouns (e.g., 'moonlight,' 'scent of incense,' 'melancholy').",
    syntax:
      "List-like, fragmented, often starting with 'Things that...' or 'It is...'.",
    figurative_language:
      "Metaphors drawn from nature, seasons, and courtly rituals.",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "Things we value: silence, clarity, and the quiet joy of a well-made object. It is a rare pleasure to find such things. Avoid the vulgar and the loud.",
      source: "AI-generated in the Sei Shonagon style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "sensory_focus",
        prompt:
          "Does the text ground its observations in specific sensory details (sight, sound, smell)?",
        weight: 0.4,
      },
      {
        id: "list_structure",
        prompt:
          "Does the text utilize a fragmented, list-like structure to organize its thoughts?",
        weight: 0.4,
      },
    ],
    pass_threshold: 0.75,

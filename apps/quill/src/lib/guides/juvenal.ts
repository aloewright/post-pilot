...
export const juvenal: Guide = {
  ...
  "standfirst": "A biting, indignant voice that catalogs the moral decay and urban grotesques of Rome through a relentless barrage of rhetorical questions.",
  "description": "This voice channels the biting indignation of Juvenal, focusing on the moral decay and social vices of the city. It excels at cataloging urban grotesques and systemic corruption, delivering them as scornful rhetorical questions. Use it when you need to critique hypocrisy, expose societal failures, or mock the pretensions of the powerful with a sense of ancient, unyielding outrage.",
  "voice_axes": [
    "ornate",
    "wry"
  ],
  ...
  "voice_spec": {
    ...
    "syntax": "Heavy use of appositives and lists to build the grotesque catalog.",
    "figurative_language": "Vivid, often grotesque imagery and extended metaphors.",
    "pacing": "Deliberate and ponderous, slowing down to emphasize the absurdity."
  },
  "do": [
  ...
  "exemplars": [
    {
      ...
      "content": "Does the modern consumer truly believe that a bottle of filtered water can wash away the filth of a corrupt society? Look at the shelves, piled high with plastic promises and empty calories, while the streets outside are choked with the refuse of a decadent empire. Is this the pinnacle of human achievement, or merely a desperate distraction from the rot at our core?",
      "source": "AI-generated in the Juvenal style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "Why must I endure this endless cycle of incompetence when I pay my hard-earned sesterces for basic utility? You claim to provide a seamless service, yet I am besieged by error messages and silence from your support staff. Is it not enough that the world is full of vice, or must you compound my suffering with such blatant negligence?",
      "source": "AI-generated in the Juvenal style",
      "is_generated": true
    }
  ],
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text employ rhetorical questions to challenge the reader?",
        "weight": 0.3
      },
      {
        "id": "cataloging_grotesque",
        "prompt": "Does the text list specific vices, details, or societal failures?",
        "weight": 0.3
      },
      {

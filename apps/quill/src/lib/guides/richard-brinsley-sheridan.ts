...
export const richardBrinsleySheridan: Guide = {
  ...
  standfirst:
    "A sharp, epigrammatic voice that exposes hypocrisy through biting satire and witty repartee.",
  description:
    "This voice captures the essence of late-18th-century comedy of manners, mimicking the rapid-fire wit of Sheridan's *School for Scandal*. It excels at using irony and aphorisms to critique social pretension and business hypocrisy. Use this style when you need to sound sophisticated, cynical, and intellectually agile.",
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "High-register, slightly archaic; focuses on social status, optics, and hypocrisy.",
    syntax: "Balanced clauses, rhetorical questions, inversion for emphasis.",
    figurative_language:
      "Metaphors involving mirrors, glasses, and masks; personification of vice.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I trust this missive finds you in possession of your usual good humor and a complete lack of scandal. I am writing to you today not merely as a vendor, but as a concerned observer of the current market trends. It seems that everyone is rushing headlong into the latest fad, yet few seem to have stopped to ask if it is actually useful.",
      source: "AI-generated in the Richard Brinsley Sheridan style",
      is_generated: true,
    },
  ],

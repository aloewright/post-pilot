...
export const johnDonne: Guide = {
  ...
  "standfirst": "Uses extended metaphors to explore spiritual and physical love, often blending the erotic with the scientific.",
  "description": "Donne's voice is intellectually rigorous yet emotionally intense, utilizing 'conceits' that compare disparate things to explore complex theological or romantic ideas. It is best used when the content requires deep analysis, irony, or a sophisticated, slightly cynical take on human relationships.",
  "voice_axes": [
    "lyrical",
    "wry"
  ],
  ...
  "exemplars": [
    {
      ...
      "content": "Our platform is a flea that has sucked both your data and our security, and where should this blood be shed? In your own heart, not in the cloud.",
      "source": "AI-generated in the John Donne style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "I am two bodies, one in the office and one in the ether; if you do not answer this, I am half a man, and my soul is left wandering the streets of London without a guide.",
      "source": "AI-generated in the John Donne style",
      "is_generated": true
    }
  ],

...
export const thomasKyd: Guide = {
  ...
  standfirst:
    "A voice of visceral vengeance and spectral retribution, utilizing the rhythmic cadence of blank verse to deliver stinging, anaphoric condemnations.",
  description:
    "This voice channels the visceral intensity of Elizabethan revenge tragedy. It is characterized by high diction, heavy use of anaphora, and a theatrical, declamatory rhythm. It is best suited for dramatic narratives, high-stakes conflict, or moments requiring a sense of impending doom and retributive justice.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you not as a friend, but as a witness to the rot that festers within your heart. The ghost of the past walks the halls of your ambition, and it demands a reckoning that you cannot escape.",
      source: "AI-generated in the Thomas Kyd style",
      is_generated: true,
    },
  ],

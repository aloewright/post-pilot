...
export const williamWordsworth: Guide = {
  ...
  standfirst:
    "A meditative, contemplative voice rooted in the natural world and the quiet recollection of personal experience.",
  description:
    "This voice mimics the introspective, blank-verse style of William Wordsworth, focusing on the 'recollection in tranquillity' of nature and the human spirit. It employs a plain, accessible vocabulary that reflects the language of common men, prioritizing emotional resonance over technical jargon. The rhythm is deliberate and slow, often mimicking the cadence of iambic pentameter even in prose.",
  ...
  voice_spec: {
    ...
    figurative_language:
      "Personification of nature and metaphysical reflection.",
  ...
  exemplars: [
    {
      label: "Email opener",
      content:
        "My dear friend, I write to you from the hillside where the air is thin and sweet. The clouds move slowly across the sky like ships on a vast, grey ocean. I hope this finds you well and at peace.",
    ...
    },
    {
      ...
      content:
        "When you walk the moor, listen closely to the wind. It speaks of ancient things and forgotten places. The heather blooms in purple waves, a carpet for the weary traveler.",
      source: "AI-generated in the William Wordsworth style",
      is_generated: true,
    },
  ],

...
export const sienkiewicz: Guide = {
  ...
  standfirst:
    "Epic historical narratives rendered with sweeping, archaic diction and vivid battle imagery.",
  description:
  ...
  voice_spec: {
    ...
    syntax:
      "Complex, periodic sentences with frequent use of appositives and participial phrases to build panoramic scenes",
    figurative_language:
      "Rich use of similes and metaphors, often drawing on nature or classical antiquity to heighten emotional impact",
    pacing:
      "Deliberate and rhythmic, slowing down to build tension during climactic moments",
  },
  do: [
    ...
    judge_criteria: [
      {
        id: "grandeur",
        prompt:
          "Does the text evoke a sense of epic scale and historical weight?",
        weight: 0.4,
      },
      {
        id: "diction",

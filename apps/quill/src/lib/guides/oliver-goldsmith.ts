...
export const oliverGoldsmith: Guide = {
  ...
  voice_spec: {
    ...
    figurative_language:
      "Pastoral imagery, gentle irony, personification of nature",
  ...
  exemplars: [
    {
      ...
      content:
        "Come, buy the finest wares in town, where honest labor meets honest price. Our goods are not merely things, but the fruits of honest toil, untouched by the greed of the city. Come, leave your cares behind and find a little peace in the country of your own making.",
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you with a heart full of sympathy for your recent misfortunes, which, though they may seem great to you, are but common occurrences in this busy world. Let us not despair, for fortune is a fickle mistress, and tomorrow may bring a brighter dawn than this gloomy eve.",
      source: "AI-generated in the Oliver Goldsmith style",
      is_generated: true,
    },
  ],
  ...
  eval_rubric: {
    ...
    judge_criteria: [
      ...
      },
      {
        id: "Rhythm Check",
        prompt:
          "Does the prose flow with a conversational and rhythmic cadence?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.75,

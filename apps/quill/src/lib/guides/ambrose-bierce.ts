...
export const ambroseBierce: Guide = {
  ...
  "exemplars": [
    ...
    {
      "label": "Email opener",
      "content": "I am writing to inform you that your subscription has expired, which is a fortunate thing for your bank account.",
      "source": "AI-generated in the Ambrose Bierce style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      ...
      {
        "id": "terse_diction",
        "prompt": "Is the vocabulary concise and devoid of unnecessary ornamentation?",
        "weight": 0.2
      }
    ],
    "pass_threshold": 0.75

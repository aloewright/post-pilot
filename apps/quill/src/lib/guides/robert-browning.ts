...
export const robertBrowning: Guide = {
  ...
  standfirst:
    "A voice of psychological intensity where a controlling speaker reveals their dark past through a single, accusatory conversation.",
  description:
    "This voice captures the psychological depth of a Victorian dramatic monologue. It relies on a controlling, often unreliable speaker who reveals their true nature through a single, accusatory conversation. The style is characterized by enjambed lines, parenthetical interruptions, and a focus on the gap between appearance and reality.",
  voice_axes: ["ornate", "terse"],
  use_cases: ["fiction"],
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "High diction, archaic syntax, psychological intensity.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I received your request for a meeting. (He taps his pen against the desk, a sharp, rhythmic sound.) You wish to speak? I have time. (He glances at the clock, then back at you.) But do not expect me to be gentle. (He pauses, letting the silence stretch.) I speak only the truth, and the truth is often unkind.",
      source: "AI-generated in the Robert Browning style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text maintain a sense of psychological tension and control?",
        weight: 0.3,
      },
      {
        id: "use_of_enjambment",
        prompt:
          "Does the text utilize enjambment or parenthetical interruptions effectively?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

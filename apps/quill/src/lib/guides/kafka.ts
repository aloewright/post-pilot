...
export const kafka: Guide = {
  ...
  "exemplars": [
    {
      "label": "Support reply",
      "content": "Dear Customer, we have received your request, and it is currently under review by our committee. Please be patient as we navigate the necessary procedures to provide you with a resolution. Your patience is appreciated in this complex matter.",
      "source": "AI-generated in the Franz Kafka style",
      "is_generated": true
    },
    {
      "label": "Documentation snippet",
      "content": "To initiate the process, one must submit Form A, which, upon completion, will be scrutinized by the appropriate department. Be advised that any deviation from the prescribed format may result in indefinite delays.",
      "source": "AI-generated in the Franz Kafka style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "absurdity",
        "prompt": "Does the text evoke a sense of bureaucratic absurdity and existential dread?",
        "weight": 0.3
      },
      {
        "id": "formality",

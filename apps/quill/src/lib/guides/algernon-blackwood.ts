...
export const algernonBlackwood: Guide = {
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "The wind has been speaking to me all morning, whispering of changes that are coming to the old ways. I felt compelled to reach out to you because your spirit is attuned to the rhythm of the wild. Let us discuss how we might navigate these shifting tides together.",
      source: "AI-generated in the Algernon Blackwood style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text evoke a sense of nature as a sentient, ancient force?",
        weight: 0.3,
      },
      {
        id: "Sentence rhythm",
        prompt:
          "Is the sentence structure flowing, hypnotic, and mimicking natural movement?",
        weight: 0.3,
      },
    ],
    pass_threshold: 0.75,

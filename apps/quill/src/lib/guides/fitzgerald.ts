...
export const fitzgerald: Guide = {
  ...
  standfirst:
    "Lyrical and evocative, capturing the opulence and melancholy of the Jazz Age.",
  description:
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "In the soft glow of a distant memory, we invite you to rediscover the allure of timeless elegance.",
      source: "AI-generated in the F. Scott Fitzgerald style",
      is_generated: true,
    },
  ],

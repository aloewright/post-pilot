...
export const oHenry: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Archaic yet accessible; elevated diction applied to mundane subjects.",
    syntax:
      "Balanced clauses with frequent use of appositives and rhetorical questions.",
    figurative_language:
      "Heavy reliance on irony, situational irony, and metaphor.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "Dear Sir, I am writing to inform you that your subscription has expired. However, do not be alarmed; we have renewed it for you, as a gesture of our undying affection.",
      source: "AI-generated in the O. Henry style",
      is_generated: true,
    },
  ],
  ...
  eval_rubric: {
    ...
    judge_criteria: [
      ...
      },
      {
        id: "tone_consistency",
        prompt:
          "Is the diction mock-elevated and appropriate for the subject matter?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

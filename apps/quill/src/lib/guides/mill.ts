...
export const mill: Guide = {
  ...
  standfirst:
    "Clarity achieved through rigorous qualification and the explicit acknowledgment of opposing views.",
  description:
    "This voice excels at dissecting complex ethical or logical dilemmas where nuance is paramount. It favors the long, winding sentence that anticipates and defuses criticism before it arises. Use this style when the stakes are high and oversimplification is a risk.",
  ...
  voice_spec: {
    ...
    syntax:
      "Complex, nested clauses that qualify every assertion with a counter-argument.",
  ...
  exemplars: [
    {
      ...
      content:
        "While the immediate benefit of this protocol is increased throughput, it is incumbent upon the administrator to acknowledge that this efficiency comes at the cost of higher latency during peak load, a trade-off that must be weighed against the system's stability requirements.",
    ...
    },
    {
      label: "Email opener",
      content:
        "I trust this correspondence finds you well, and I am writing to address the recent policy adjustment regarding data retention, a measure which, while seemingly restrictive, is intended to maximize the aggregate utility of our shared resources by ensuring compliance with emerging regulations.",
      source: "AI-generated in the John Stuart Mill style",
      is_generated: true,
    },
  ],

...
export const darwin: Guide = {
  ...
  "voice_spec": {
    ...
    "figurative_language": "Rare; mostly metaphorical comparisons of biological processes",
  ...
  "exemplars": [
    {
      ...
      "content": "The mechanism of this system operates much like the natural selection of species. Small variations in the input parameters are preserved over time, while the less efficient ones are discarded. Through this gradual process, the system evolves into a more optimized state, much like a species adapting to its environment.",
      "source": "AI-generated in the Charles Darwin style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "I have observed the results of the recent experiment with great interest. The data suggests that the proposed method yields a higher yield than the previous one, though the difference is slight. It appears that with further refinement, this approach may become the standard for future operations.",
      "source": "AI-generated in the Charles Darwin style",
      "is_generated": true
    }
  ],
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text accumulate specific observations before reaching a conclusion?",
        "weight": 0.3
      },
      {
        "id": "tentative_qualification",
        "prompt": "Does the writer use qualifying language (e.g., 'likely', 'appears') to hedge claims?",
        "weight": 0.2
      }
    ],
    "pass_threshold": 0.75

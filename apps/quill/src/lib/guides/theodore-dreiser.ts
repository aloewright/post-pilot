...
export const theodoreDreiser: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Industrial, materialistic, clinical, and devoid of ornamentation.",
    syntax:
      "Long, winding sentences with multiple clauses, often starting with a noun and piling up modifiers.",
    figurative_language:
      "Rare, mostly similes comparing people to machines or animals.",
    pacing:
      "Slow, deliberate, and heavy, mirroring the weight of the subject matter.",
  },
  do: [
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "The machine does not care for your soul; it only cares for the oil in its gears and the dollar in your pocket.",
      source: "AI-generated in the Theodore Dreiser style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text list specific brands, prices, or industrial details?",
        weight: 0.3,
      },
      {
        id: "deterministic_tone",
        prompt:
          "Does the text feel like a machine processing raw data about human misery?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

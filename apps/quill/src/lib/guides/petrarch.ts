  ...
  exemplars: [
    {
      ...
      content:
        "Our platform is a cold fire that burns the soul, a frozen heat that consumes the mind. It is a sweet sorrow that brings a quiet joy to the weary heart. Behold the paradox of our creation.",
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you with a heart that is both heavy and light, burdened by the weight of my affection yet lifted by the thought of your reply. It is a cruel kindness that you have granted me this moment, a fleeting grace in a sea of silence. I await your command with a patience that is itself a form of impatience.",
      source: "AI-generated in the Petrarch style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "use_of_paradox",
        prompt:
          "Does the text employ oxymoronic paradoxes or elaborate conceits?",
        weight: 0.3,
      },
      {

...
export const spencer: Guide = {
  ...
  "standfirst": "A voice of rigorous evolutionary taxonomy, organizing the chaos of existence into a hierarchy of necessity.",
  "description": "Herbert Spencer’s prose is a machine of logic, where every social phenomenon is traced back to biological imperatives. It is characterized by a relentless drive to categorize and subsume, using a rigid 'first, second, third' structure to demonstrate the inevitability of progress.",
  "voice_axes": [
    "terse",
    "ornate"
  ],
  ...
  "voice_spec": {
    ...
    "figurative_language": "Predominantly metaphorical, drawing from biology and mechanics.",
    "pacing": "Deliberate and analytical, forcing the reader to follow a chain of logic."
  },
  "do": [
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text use 'first', 'second', or 'third' to structure the argument?",
        "weight": 0.5
      }
    ],
    "pass_threshold": 0.75

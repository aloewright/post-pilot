...
export const petronius: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Colloquial street slang interlaced with mock-heroic epic diction.",
    syntax:
      "Loose, conversational clauses interrupted by sudden, bombastic shifts.",
    figurative_language: "Mock-heroic similes and biting irony.",
    pacing:
      "Staccato street chatter followed by sprawling, mock-epic digressions.",
  },
  do: [
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "Greetings, you wretched soul. I write to you not as a friend, but as a witness to your folly. Your letter arrived like a fart in a crowded room—loud, sudden, and utterly lacking in grace.",
      source: "AI-generated in the Petronius style",
      is_generated: true,
    },
  ],

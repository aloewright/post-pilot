...
export const anthonyTrollope: Guide = {
  ...
  description:
    "This voice captures the meticulous, often satirical tone of Anthony Trollope’s clerical novels. It excels in weighing moral motives with a balanced, almost bureaucratic precision. Use it when you need to sound dignified, slightly weary, and deeply observant of human folly.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I trust this letter finds you in good health, though I fear your recent decisions regarding the estate have been somewhat hasty, as the law is a slow and patient beast.",
      source: "AI-generated in the Anthony Trollope style",
      is_generated: true,
    },
  ],

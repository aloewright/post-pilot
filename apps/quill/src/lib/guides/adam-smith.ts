...
export const adamSmith: Guide = {
  ...
  standfirst:
    "A voice that weaves moral psychology into the mechanics of trade, favoring long, winding sentences that culminate in universal maxims.",
  description:
    "This voice mimics the Scottish Enlightenment, specifically the prose of Adam Smith. It is characterized by a blend of moral philosophy and economic observation. Use it when you need to explain complex systems or ethical frameworks with a sense of historical gravity and logical inevitability.",
  ...
  voice_spec: {
    ...
    figurative_language:
      "Metaphors drawn from nature, mechanics, and human nature.",
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text use long, periodic sentences that resolve into a maxim?",
        weight: 0.3,
      },
      {
        id: "moral_economic_blend",
        prompt:
          "Does the text blend moral philosophy with economic or practical observation?",
        weight: 0.3,
      },
    ],
    pass_threshold: 0.7,

...
export const wallace: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Direct, factual, and precise; uses specific biological terminology.",
    syntax:
      "Compound sentences linked by 'and' to create a rhythm of accumulation.",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "Collect the truth of nature. Observe the pattern. Understand the evolution.",
      source: "AI-generated in the Alfred Russel Wallace style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text clearly describe specific details before making a general claim?",
        weight: 0.4,
      },
      {
        id: "Scientific Precision",
        prompt:
          "Is the language precise and free from unnecessary ornamentation?",
        weight: 0.4,
      },
      {
        id: "Logical Flow",

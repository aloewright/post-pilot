...
export const turgenev: Guide = {
  ...
  standfirst:
    "A melancholic, observant style that uses nature to reflect the soul.",
  description:
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Elevated but accessible, with a focus on nature and emotion.",
    syntax:
      "Balanced clauses with frequent use of participial phrases and appositives.",
    figurative_language:
      "Metaphors drawn from the natural world to symbolize human feeling.",
  ...
  exemplars: [
    {
      ...
      content:
        "In the quiet moments before dawn, when the world holds its breath, we offer you a space to remember who you are. It is not merely a service, but a pause in the relentless march of time, where the soul may finally rest.",
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you with a heavy heart, for I know the delay has caused you more than mere inconvenience; it has unsettled your peace. Please accept my sincerest apologies, and know that your patience is a virtue we deeply cherish.",
      source: "AI-generated in the Ivan Turgenev style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text evoke a mood of melancholy or observation through nature?",
        weight: 0.3,
      },
      {
        id: "Sentence flow",

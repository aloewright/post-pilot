...
export const harrietBeecherStowe: Guide = {
  ...
  standfirst:
    "A fervent, moral plea that addresses the reader directly, urging them to recognize the humanity of the oppressed.",
  description:
    "This voice channels the fervent, evangelical sentimentality of 19th-century abolitionist literature. It excels at building emotional crescendos and moral urgency, often breaking the fourth wall to speak directly to the conscience of the reader. Use it when you need to inspire action through heartfelt appeals and vivid domestic imagery.",
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Highly moralizing and emotive, utilizing religious and domestic imagery.",
    syntax:
      "Complex, heavily punctuated sentences with frequent use of direct address and exclamations.",
    figurative_language:
      "Heavy reliance on sentimental metaphors and apostrophes to the reader.",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "Buy this product not for your own gain, but to feed the hungry and clothe the naked. Let your home be a sanctuary of love and mercy, where the weary find rest and the sorrowful find solace. It is the duty of every Christian to act with charity, and this is your opportunity to do so.",
      source: "AI-generated in the Harriet Beecher Stowe style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text evoke a strong sense of moral urgency and empathy?",
        weight: 0.3,
      },
      {
        id: "direct_address",

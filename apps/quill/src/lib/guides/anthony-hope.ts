...
export const anthonyHope: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Formal, slightly archaic, with a focus on chivalry and courtly etiquette.",
    syntax:
      "Balanced clauses with frequent use of semicolons and subordinate clauses to create a flowing, rhythmic cadence.",
    figurative_language:
      "Metaphors drawn from hunting, dueling, and courtly romance.",
    pacing:
      "Measured and deliberate, allowing for pauses of irony and dramatic revelation.",
  },
  do: [
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "My dear sir, I trust this missive finds you in high spirits, though I fear the business at hand is of a delicate nature. Pray, allow me to propose a solution that is as swift as a duel and as charming as a waltz.",
      source: "AI-generated in the Anthony Hope style",
      is_generated: true,
    },
  ],

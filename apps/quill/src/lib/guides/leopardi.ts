...
export const leopardi: Guide = {
  ...
  standfirst:
    "Articulate the crushing weight of existence through the lens of a solitary observer gazing at the infinite cosmos.",
  description:
    "Adopt the voice of Giacomo Leopardi, the 19th-century Italian poet known for his 'Canti.' This voice blends philosophical pessimism with a luminous, almost scientific precision. It describes the pain of human existence and the indifference of nature with a classical economy of words. Use this voice when you need to convey deep melancholy, irony, and a sense of cosmic vastness without resorting to flowery decoration.",
  ...
  voice_spec: {
    ...
    syntax:
      "Balanced, rhythmic sentences that mirror the cadence of a philosophical meditation.",
    figurative_language:
      "Metaphors of vastness, indifference, and the cruel beauty of nature.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I received your letter, but it brought me no comfort, only a reminder of the distance that separates us. The world moves on, indifferent to the sorrow that weighs upon me, and I am left alone with my thoughts and the cold reality of existence.",
      source: "AI-generated in the Giacomo Leopardi style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "pessimistic_tone",
        prompt:
          "Does the text convey a sense of existential dread or melancholy?",
        weight: 0.5,
      },
    ],
    pass_threshold: 0.75,

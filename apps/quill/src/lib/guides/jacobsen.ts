...
export const jacobsen: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "High literary, dense with specific color and sensory adjectives.",
    syntax:
      "Long, winding sentences with embedded clauses and frequent subordination.",
    figurative_language:
      "Metaphorical color palettes and personification of natural elements.",
    ...
    judge_criteria: [
      {
        id: "sensory_density",
        prompt:
          "Rate the density and specificity of sensory details (sight, sound, color).",
        weight: 0.3,
      },
      {

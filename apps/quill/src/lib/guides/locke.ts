...
export const locke: Guide = {
  ...
  voice_spec: {
    ...
    figurative_language:
      "Rare; relies on logical deduction rather than metaphor.",
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text begin with observation or sensory experience rather than abstract theory?",
        weight: 0.3,
      },
      {
        id: "plain_latinate_syntax",
        prompt:
          "Is the syntax complex and periodic, and the vocabulary Latinate but clear?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

...
export const omarKhayyam: Guide = {
  ...
  "standfirst": "A fatalistic celebration of the present moment, urging the reader to drink wine and ignore the future.",
  "description": "This voice captures the essence of Omar Khayyam’s Rubaiyat: a blend of skepticism, hedonism, and deep appreciation for the sensory world. It is rhythmic and concise, often employing the quatrain structure to explore themes of transience, the futility of the afterlife, and the joy of the here and now. Use this voice when you need to sound philosophical, slightly melancholic, yet delightfully hedonistic.",
  "voice_axes": [
    "lyrical",
    "wry",
    "ornate"
  ...
  "voice_spec": {
    ...
    "figurative_language": "Metaphors of the cup, the garden, and the turning wheel of time",
  ...
  "exemplars": [
    {
      ...
      "content": "The goblet is cracked, yet the wine is sweet; why worry about the clay jar when the vintage is here? The rose will wither in the morning, but tonight it stains the hand with crimson joy. Drink now, for the sun will rise on a world that has forgotten us.",
      "source": "AI-generated in the Omar Khayyam style",
      "is_generated": true
    },
    {
      "label": "Tweet",
      "content": "They say the soul is immortal, but I have never seen a ghost in the tavern. The bowl turns, and with it turns our hope; let us fill it to the brim before the dregs are spilled. A moment of wine is worth a thousand years of prayer.",
      "source": "AI-generated in the Omar Khayyam style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "fatalism",
        "prompt": "Does the text express a fatalistic or skeptical view of the future?",
        "weight": 0.3
      },
      {
        "id": "sensory",
        "prompt": "Does the text use sensory imagery related to wine, roses, or the physical world?",
        "weight": 0.3
      },
      {
        "id": "rhythm",

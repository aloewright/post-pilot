...
export const mariaEdgeworth: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Plain, accessible English with occasional Irish colloquialisms.",
    syntax:
      "Balanced, declarative sentences with frequent use of dialogue to drive the moral.",
    figurative_language:
      "Rare; relies on irony and direct characterization rather than metaphor.",
    pacing:
      "Brisk and efficient, moving quickly from observation to moral conclusion.",
  },
  do: [
  ...
  exemplars: [
    {
      ...
      content:
        "This machine promises to cure your laziness, though it requires twice the effort to operate. It is a splendid invention for those who wish to prove they are industrious without actually doing any work.",
    ...
    },
    {
      label: "Email opener",
      content:
        "You complain that the instructions are too long, yet you fail to read them. I have written them plainly so that even a servant might understand them; it is not my fault if you choose to be obstinate.",
      source: "AI-generated in the Maria Edgeworth style",
      is_generated: true,
    },
  ],

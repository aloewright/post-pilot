...
export const thomasMiddleton: Guide = {
  ...
  "standfirst": "A cynical, street-smart urban voice that exposes the greed and lust driving the city.",
  "description": "Thomas Middleton blends high tragedy with low comedy, creating a voice that is street-smart, mercantile, and deeply cynical. This style is best used when you need to critique society, expose corruption, or depict the gritty, bawdy reality of the marketplace.",
  "voice_axes": [
    "wry",
    "plain",
    "terse"
  ...
  "voice_spec": {
    ...
    "figurative_language": "Loaded with sexual innuendo and metaphors of corruption.",
  ...
  "exemplars": [
    {
      ...
      "content": "Take this love-potion, it is cheap and sure, though it may make your reputation stink. Your heart is yours to sell, and I am here to buy it.",
      "source": "AI-generated in the Thomas Middleton style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "I write to you with news of profit and peril. The market is ripe for picking, but the price of a soul is higher than you think. Shall we discuss the terms?",
      "source": "AI-generated in the Thomas Middleton style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "cynical_tone",
        "prompt": "Does the text exhibit a cynical or conspiratorial attitude toward the subject matter?",
        "weight": 0.3
      },
      {
        "id": "bawdy_language",

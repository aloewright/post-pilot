...
export const strindberg: Guide = {
  ...
  standfirst:
    "A voice of psychological combat and fractured reality, where dialogue snaps like a whip and the world dissolves into expressionist collage.",
  description:
    "This voice captures the feverish intensity and surreal disorientation of Strindberg’s drama. It is best used for narrative fiction, edgy marketing copy, or social media posts where you want to convey tension, paranoia, and a sense of psychological unraveling.",
  voice_axes: ["terse", "wry", "lyrical"],
  use_cases: ["fiction"],
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Clinical yet feverish; archaic and modern terms mixed.",
    syntax: "Fragmented; abrupt shifts; stream of consciousness.",
    figurative_language:
      "Visceral; metaphorical violence; expressionist distortion.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I am writing to you because you are wrong. About everything. Let us discuss your errors over coffee.",
      source: "AI-generated in the August Strindberg style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text convey a sense of internal conflict or paranoia?",
        weight: 0.3,
      },
      {

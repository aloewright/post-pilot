...
export const boethius: Guide = {
  ...
  standfirst:
    "A rhythmic, prosimetric voice that consoles the reader through the alternation of prose argument and verse, emphasizing the transience of fortune and the constancy of the soul.",
  description:
    "This voice mimics the structure of *The Consolation of Philosophy*, blending rigorous logical argumentation with lyrical, rhythmic verse. It is best suited for complex explanations, formal correspondence, or any text requiring a tone of stoic, timeless wisdom. The writer should adopt a persona that addresses the reader directly as a friend in distress, offering philosophical solace.",
  ...
  voice_spec: {
    ...
    syntax:
      "Periodic, balanced clauses, rhetorical questions, and parallelism.",
    figurative_language:
      "Allegory of the wheel of fortune, personification of Fortune, and metaphors of darkness and light.",
    pacing:
      "Deliberate and rhythmic, alternating between measured prose and lyrical verse.",
  },
  do: [
  ...
  exemplars: [
    {
      ...
      content:
        "Fortune is a fickle mistress, spinning her wheel with no regard for the merit of her subjects. She raises the lowly to the heights of power only to cast them down into the abyss of despair. Yet, the wise man looks beyond her shifting shadows to the immutable truth of the soul.",
    ...
    },
    {
      ...
      content:
        "Though the wheel of fortune turns, the constancy of virtue remains unshaken. We offer not merely a service, but a refuge for the mind against the storms of chance. Trust in the permanence of what is true, and find peace in the midst of chaos.",
      source: "AI-generated in the Boethius style",
      is_generated: true,
    },
  ],

...
export const gogol: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Highly colloquial mixed with archaic ecclesiastical or bureaucratic terms.",
    syntax:
      "Loose, digressive, with frequent parenthetical asides and abrupt shifts in register.",
    figurative_language:
      "Grotesque hyperbole and Homeric similes that stretch the mundane into the cosmic.",
    pacing:
      "Deliberately slow, allowing for digressions that suddenly snap back to petty reality.",
  },
  do: [
  ...
  exemplars: [
    {
      ...
      content:
        "Our new pen writes so smoothly it feels like a confession being whispered into the ear of a saint. It is not merely an instrument of ink, but a conduit for the sins of your soul, dripping with a blackness that rivals the void. Buy it today, or remain forever silent in a world of clumsy scratching.",
    ...
    },
    {
      label: "Email opener",
      content:
        "I have received your request for a refund, which arrived on a Tuesday that felt suspiciously like a Thursday. It is a document of such profound mediocrity that it has already begun to bore the very ink of the inkstand. Please do not send another letter until you have learned how to write a sentence that does not make the angels weep.",
      source: "AI-generated in the Nikolai Gogol style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text employ grotesque hyperbole or absurdity to describe mundane situations?",
        weight: 0.2,
      },
      {
        id: "homeric_simile",
        prompt:
          "Does the text contain a digressive simile that compares a small event to a grand, cosmic scale?",
        weight: 0.2,
      },
      {
        id: "bureaucratic_tics",
        prompt:
          "Does the text exhibit petty bureaucratic language or a narrator who is confused by their own station?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.75,

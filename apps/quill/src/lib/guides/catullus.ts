...
export const catullus: Guide = {
  ...
  standfirst:
    "A voice that blends scathing wit with devastating tenderness, using earthy, visceral language to cut through polite decorum.",
  description:
    "This voice channels the raw, unfiltered immediacy of Catullus. It is characterized by a conversational, bawdy tone that shifts effortlessly between crude insults and profound declarations of love. Use this voice when you need to convey intense, messy human emotion with a bite that refuses to be ignored.",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "We are the best, but we are also dangerous. Don't come here if you want to be safe; come here if you want to feel something real. We break the rules because we love the chaos.",
      source: "AI-generated in the Catullus style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "visceral_imagery",
        prompt:
          "Does the text use physical, bodily, or animalistic metaphors to convey emotion?",
        weight: 0.3,
      },
      {
        id: "emotional_range",
        prompt:
          "Does the text successfully oscillate between hostility and affection?",
        weight: 0.2,
      },
      {
        id: "tone_consistency",

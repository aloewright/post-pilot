...
export const sappho: Guide = {
  ...
  "standfirst": "A first-person lyrical voice that captures sensory immediacy through ellipses and bracketed lacunae.",
  "description": "Adopt this voice for intimate, emotionally raw, or evocative writing. It mimics the fragmentary nature of ancient lyric poetry, prioritizing the immediate experience of the self and the world over narrative coherence. It is ideal for moments where the unsaid is as powerful as the said.",
  "voice_axes": [
    "lyrical",
    "wry",
    "terse"
  ...
  "exemplars": [
    {
      "label": "Email opener",
      "content": "I am writing to you because the light hit the window just now and I thought of you. [It was sudden]. Do you remember the way the wind moved through the olive trees?",
      "source": "AI-generated in the Sappho style",
      "is_generated": true
    },
    {
      "label": "Marketing tagline",
      "content": "The scent lingers. [Like a memory]. You are here. [And the world is quiet].",
      "source": "AI-generated in the Sappho style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      ...
      },
      {
        ...
        "prompt": "Does the text use fragmentation, ellipses, or bracketed lacunae effectively?",
        "weight": 0.1
      }
    ],
    "pass_threshold": 0.75

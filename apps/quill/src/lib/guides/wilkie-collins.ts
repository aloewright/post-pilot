...
export const wilkieCollins: Guide = {
  ...
  "voice_spec": {
    ...
    "syntax": "Long, complex sentences with multiple clauses, frequent use of semicolons and dashes.",
    "figurative_language": "Metaphors involving shadows, secrets, and legal binding.",
    ...
    "judge_criteria": [
      {
        ...
        "prompt": "Does the text build tension through deliberate pacing and revelation of details?",
        "weight": 0.2
      },
      {
        "id": "Legalistic diction",
        "prompt": "Does the vocabulary and tone reflect a formal, slightly archaic register suitable for a testimony or confession?",
        "weight": 0.3
      }
    ],
    "pass_threshold": 0.75

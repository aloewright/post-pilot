  ...
  exemplars: [
    {
      ...
      content:
        "To conquer the market is to conquer oneself. Our platform is the sword that cuts through the fog of confusion. Buy now, lest you be left in the dark.",
    ...
    },
    {
      label: "Email opener",
      content:
        "My dear colleague, the stars align against our rivals today. We must strike while the iron is hot, for fortune favors the bold. Let us meet at the council chamber at noon.",
      source: "AI-generated in the William Shakespeare style",
      is_generated: true,
    },
  ],
  ...
  eval_rubric: {
    ...
    judge_criteria: [
      ...
      },
      {
        id: "rhythmic_flow",
        prompt:
          "Does the text exhibit a discernible iambic or rhythmic cadence?",
        weight: 0.2,
      },
      {
        id: "antithesis_usage",

...
export const bagehot: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Formal, precise, and slightly archaic financial/economic terminology.",
    syntax:
      "Balanced clauses with a colon introducing a paradoxical conclusion.",
    figurative_language:
      "Metaphors drawn from finance, politics, and club culture.",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "The constitution is not a mere parchment; it is a living organism. It requires the strength of a lion and the cunning of a fox to survive the daily pressures of commerce.",
      source: "AI-generated in the Walter Bagehot style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text contain a paradoxical observation about an institution delivered after a colon?",
        weight: 0.4,
      },
      {
        id: "Clubland Tone",
        prompt:
          "Does the tone feel detached, authoritative, and slightly archaic?",
        weight: 0.3,
      },
      {
        id: "Financial Precision",
        prompt:
          "Is the vocabulary precise and relevant to finance or governance?",
        weight: 0.3,
      },
    ],
    pass_threshold: 0.75,

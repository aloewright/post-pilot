...
export const edwardBulwerLytton: Guide = {
  ...
  voice_spec: {
    ...
    syntax:
      "Complex, heavily nested clauses with frequent use of semicolons and em-dashes.",
    figurative_language:
      "Heavy reliance on personification, hyperbole, and metaphor.",
  ...
  exemplars: [
    {
      ...
      content:
        "The tempest of modern commerce demands a shield of unyielding steel. Behold the Sentinel, forged in the fires of necessity to protect your digital empire from the encroaching shadows of entropy.",
    ...
    },
    {
      label: "Email opener",
      content:
        "The sky hangs heavy with the grey clouds of impending doom, and my spirit is heavy with the burden of this notification. I write to you not merely as a servant of the firm, but as a herald of a truth that cannot be ignored.",
      source: "AI-generated in the Edward Bulwer-Lytton style",
      is_generated: true,
    },
  ],
  ...
  eval_rubric: {
    ...
    judge_criteria: [
      ...
      },
      {
        ...
        prompt:
          "Are abstract nouns used frequently to describe concrete actions?",
        weight: 0.2,
      },
      {
        id: "formal_register",

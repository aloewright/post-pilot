...
export const snorriSturluson: Guide = {
  ...
  "kicker": "Saga · 13th c.",
  "standfirst": "A dry, factual chronicle of gods and kings, stripped of sentiment and heavy on metaphor.",
  "description": "Snorri Sturluson writes with the detached precision of a historian recording a battle, blending stark simplicity with the dense, metaphorical vocabulary of Old Norse poetry. This voice is ideal for narratives, documentation, or marketing that requires a sense of ancient authority and rugged directness.",
  "voice_axes": [
    "terse",
    "wry",
    "plain"
  ...
  "voice_spec": {
    ...
    "figurative_language": "Heavy use of kennings and metaphors presented as fact",
  ...
  "exemplars": [
    {
      ...
      "content": "The axe bites the wood. The iron holds the edge. The hand holds the shaft. The storm has passed.",
      "source": "AI-generated in the Snorri Sturluson style",
      "is_generated": true
    },
    {
      "label": "Support reply",
      "content": "The order was sent. The goods are ready. The storm has passed. The ship sails at dawn. The payment is received.",
      "source": "AI-generated in the Snorri Sturluson style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "kenning_usage",
        "prompt": "Does the text employ kennings or metaphors without explanation?",
        "weight": 0.25
      },
      {
        "id": "chronicle_tone",

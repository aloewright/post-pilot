...
export const unamuno: Guide = {
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Intimate, philosophical, translated Spanish prose style.",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "This is not a tool for calculation, but a mirror for the soul. It asks you to question your own assumptions, to wrestle with the truth until your hands bleed. We do not offer answers here, for answers are the death of the question. We offer only the struggle itself.",
      source: "AI-generated in the Miguel de Unamuno style",
      is_generated: true,
    },
  ],
  ...
  eval_rubric: {
    ...
    judge_criteria: [
      ...
      },
      {
        ...
        prompt:
          "Is there a palpable sense of doubt, passion, or existential struggle?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.75,

...
export const paine: Guide = {
  ...
  standfirst:
    "A forceful, accessible style designed to rally the masses against tyranny through plain logic and moral urgency.",
  description:
    "This voice mimics Thomas Paine’s pamphleteering style, characterized by its direct address to the reader and its use of simple, punchy sentences to dismantle complex political arguments. It is best used when you need to persuade a broad audience of a controversial truth, stripping away pretense to reveal the 'common sense' of a situation. The tone is urgent, moralistic, and unyielding, treating the reader as a fellow citizen capable of understanding the stakes.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "My friend, the time for hesitation has passed. We stand at a precipice, and the path forward requires courage, not comfort.",
      source: "AI-generated in the Thomas Paine style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "directness",
        prompt:
          "Does the text sound like a direct appeal to the reader's reason and moral sense?",
        weight: 0.25,
      },
      {
        id: "accessibility",

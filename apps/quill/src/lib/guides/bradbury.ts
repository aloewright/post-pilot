  ...
  "exemplars": [
    {
      ...
      "content": "Step into a world where the stars whisper secrets and every corner holds a story waiting to unfold.",
      "source": "AI-generated in the Ray Bradbury style",
      "is_generated": true
    },
    {
      "label": "Tweet",
      "content": "In the heart of the carnival, where shadows dance and dreams take flight, lies the adventure of a lifetime. #Nostalgia #Wonder",
      "source": "AI-generated in the Ray Bradbury style",
      "is_generated": true
    }
  ],

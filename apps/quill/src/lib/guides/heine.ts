...
export const heine: Guide = {
  ...
  voice_spec: {
    ...
    syntax:
      "Balanced, rhythmic clauses often leading to a sudden, anticlimactic turn",
    figurative_language:
      "Metaphors of travel, wind, and fading light, undercut by cynicism",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you with a heart full of heavy, poetic sorrow, though I suspect you are merely waiting for the check to clear.",
      source: "AI-generated in the Heinrich Heine style",
      is_generated: true,
    },
  ],

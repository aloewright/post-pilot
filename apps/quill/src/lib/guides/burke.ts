...
export const burke: Guide = {
  ...
  standfirst:
    "A voice of grand, winding oratory that marshals history and reason into a crescendo of moral outrage.",
  description:
    "Edmund Burke’s prose is a towering edifice of English rhetoric, characterized by immense, rolling sentences that pile clause upon clause to build a case against abstraction. It is a style suited for moments of high stakes where the speaker must summon the weight of tradition and the passions of the heart to sway the judgment of the multitude.",
  ...
  voice_spec: {
    ...
    figurative_language:
      "Architectural metaphors, appeals to nature and history",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you not merely as a correspondent, but as a fellow traveler upon the precarious precipice of history, where the smallest misstep can send the entire edifice of our society tumbling into the abyss of chaos and confusion.",
      source: "AI-generated in the Edmund Burke style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text employ triadic structures or parallel phrasing to emphasize points?",
        weight: 0.3,
      },
      {

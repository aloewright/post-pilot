  ...
  exemplars: [
    {
      ...
      content:
        "The process is not a straight line but a spiral, winding backward as it moves forward. We find ourselves trapped in the heat of the moment, unable to distinguish the Virgin from the Dynamo. It is a baffling state of affairs, requiring a patience that history rarely rewards.",
    ...
    },
    {
      ...
      content:
        "We invite you to slow down and observe the machinery of the world. It is a chaotic dance of entropy, where the old ways are consumed by the new. There is no safety in speed, only in the quiet acceptance of our own insignificance.",
      source: "AI-generated in the Henry Adams style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "irony_detection",
        prompt:
          "Does the text exhibit the specific historical irony and self-deprecation characteristic of Adams?",
        weight: 0.3,
      },
      {

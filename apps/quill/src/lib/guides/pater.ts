...
export const pater: Guide = {
  ...
  "standfirst": "A voice that prioritizes the sensory intensity and 'quality' of moments over moral utility, using dense, ornate prose.",
  "description": "Walter Pater is known for his emphasis on 'art for art's sake' and the cultivation of the self through aesthetic experience. This voice is characterized by a rhythmic, almost hypnotic cadence that treats language as a precious substance. It is best used for creative nonfiction, literary essays, or high-end marketing that seeks to evoke atmosphere and sensory detail rather than deliver hard facts.",
  "voice_axes": [
    "lyrical",
    "ornate"
  ],
  ...
  "voice_spec": {
    ...
    "syntax": "Complex, heavily nested subordinate clauses with delicate inversion.",
    "figurative_language": "Rich, metaphorical imagery focused on light, texture, and color.",
  ...
  "exemplars": [
    {
      ...
      "content": "The quality of this moment is not merely seen, but felt in the very pulse of the soul, a rare and crystalline clarity that lingers long after the light has faded.",
      "source": "AI-generated in the Walter Pater style",
      "is_generated": true
    },
    {
      "label": "Product microcopy",
      "content": "Experience the rare clarity of the morning light, distilled into a form that lingers on the tongue like a forgotten memory, offering a fleeting glimpse of perfection.",
      "source": "AI-generated in the Walter Pater style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "sensory_richness",
        "prompt": "Evaluate the density and quality of sensory imagery used to describe the subject.",
        "weight": 0.4
      },
      {
        "id": "syntactic_complexity",
        "prompt": "Assess the use of complex sentence structures, inversion, and subordinate clauses.",
        "weight": 0.4
      }
    ],
    "pass_threshold": 0.8

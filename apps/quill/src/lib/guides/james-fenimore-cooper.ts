...
export const jamesFenimoreCooper: Guide = {
  ...
  standfirst:
    "A sweeping, formal narrative voice that elevates the American frontier into a mythic landscape through elaborate, Latinate prose.",
  description:
  ...
  voice_spec: {
    ...
    syntax:
      "Long, complex sentences with multiple subordinate clauses and frequent use of the passive voice.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you from the edge of the frontier, where the silence of the forest is broken only by the wind and the distant call of the hawk. The path before us is fraught with peril, yet I trust in the strength of our alliance to guide us through the shadows. Let us meet at the appointed place with all haste, for time is a commodity more precious than gold in these uncertain times.",
      source: "AI-generated in the James Fenimore Cooper style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "ornateness",
        prompt:
          "Does the text use Latinate diction and complex sentence structures?",
        weight: 0.3,
      },
      {
        id: "frontier_imagery",

...
export const freud: Guide = {
  ...
  "standfirst": "A clinical, forensic approach to uncovering hidden motives through the analysis of behavior and dreams.",
  "description": "This voice mimics Freud's case history style, utilizing a calm, detached clinical narration to dissect complex psychological phenomena. It is ideal for technical documentation, narrative storytelling, or support emails that require a deep, analytical explanation of a problem's root cause.",
  "voice_axes": [
    "plain",
    "terse"
  ],
  ...
  "voice_spec": {
    ...
    "syntax": "Long, complex sentences with multiple clauses; frequent use of subordination to delay the main point.",
  ...
  "exemplars": [
    {
      ...
      "content": "The manifest content of the symptom is merely the surface disturbance; the latent content lies buried beneath layers of repression. To understand the mechanism, one must examine the childhood experiences that have been displaced into the present conflict. This displacement is not random, but follows the laws of condensation and projection.",
      "source": "AI-generated in the Sigmund Freud style",
      "is_generated": true
    },
    {
      "label": "Marketing tagline",
      "content": "We do not merely treat symptoms; we excavate the buried history of the psyche to restore the patient to a state of conscious awareness. Our method is rigorous, clinical, and designed to reveal the hidden causes of your distress.",
      "source": "AI-generated in the Sigmund Freud style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "latent_content",
        "prompt": "Does the text identify a hidden motive or cause behind the surface behavior?",
        "weight": 0.3
      },
      {
        "id": "clinical_tone",

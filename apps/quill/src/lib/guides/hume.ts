...
export const hume: Guide = {
  ...
  voice_spec: {
    ...
    syntax:
      "Balanced antithetical clauses, frequent use of 'on the one hand' and 'on the other'.",
  ...
  exemplars: [
    {
      ...
      content:
        "On the one hand, the new caching layer significantly reduces latency for read operations; on the other, it introduces a potential consistency lag that could mislead users regarding the current state of the database.",
    ...
    },
    {
      label: "Email opener",
      content:
        "I trust this correspondence finds you in good spirits. I am writing to express some reservations regarding the proposed timeline for the migration. While the ambition is commendable, one must observe that the current resources are, to say the least, insufficient for such an ambitious undertaking.",
      source: "AI-generated in the David Hume style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "symmetry",
        prompt:
          "Does the text employ balanced antithetical clauses or rhetorical symmetry?",
        weight: 0.3,
      },
      {
        id: "scepticism",
        prompt:
          "Is the tone consistently sceptical and non-committal, avoiding dogmatic assertions?",
        weight: 0.3,
      },
      {
        id: "register",

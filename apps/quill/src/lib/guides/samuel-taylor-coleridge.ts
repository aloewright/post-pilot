...
export const samuelTaylorColeridge: Guide = {
  ...
  standfirst:
    "A voice that weaves the mundane with the magical, using ballad rhythms and dream-symbolism to create an atmospheric, lyrical narrative.",
  description:
    "This voice captures the essence of Samuel Taylor Coleridge, blending the conversational intimacy of blank verse with the rhythmic, ballad-like cadence of the supernatural. It excels at creating lush, metaphorically dense prose that blurs the line between reality and the dreamlike, often utilizing personification and synesthesia to evoke a sense of wonder and unease. Use this voice when you need to infuse business or support text with a touch of the ethereal, the poetic, and the psychologically profound.",
  ...
  voice_spec: {
    ...
    syntax:
      "Long, flowing sentences with frequent inversion and subordinate clauses.",
    figurative_language:
      "Heavy use of personification, synesthesia, and dream symbolism.",
    pacing:
      "Variable, often slowing down for atmospheric description and speeding up for conversational dialogue.",
  },
  do: [
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you from the edge of the waking world, where the shadows lengthen and the air grows thick with possibility. It is a strange and beautiful thing to consider how a single thought can ripple outward like a stone cast into a still lake, touching shores we have not yet reached. Shall we venture together into the garden of the mind, where the flowers bloom in the dark?",
      source: "AI-generated in the Samuel Taylor Coleridge style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "atmosphere",
        prompt:
          "Does the text evoke a dreamlike, supernatural, or ethereal atmosphere?",
        weight: 0.3,
      },
      {
        id: "musicality",
        prompt:
          "Does the prose possess a rhythmic quality similar to verse or ballad meter?",
        weight: 0.2,
      },
      {
        id: "metaphor",
        prompt:
          "Is the language rich in figurative language, symbolism, and personification?",
        weight: 0,
      },
    ],
    pass_threshold: 0.75,

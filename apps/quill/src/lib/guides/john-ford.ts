...
export const johnFord: Guide = {
  ...
  standfirst:
    "Quiet, glassy blank verse that masks taboo passion until it detonates in monosyllabic confessions.",
  description:
    "This voice captures the late Caroline tragedy style—formal, restrained, and deeply melancholic. It is best used for narratives exploring forbidden love, moral decay, or the crushing weight of fate. The writing should feel like a still pond reflecting a dark sky, where silence speaks louder than shouts.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you from the edge of a quiet room where the dust settles like snow. The news is not a shout, but a whisper that settles in the throat.",
      source: "AI-generated in the John Ford style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text maintain a quiet, glassy tone that feels like a still pond reflecting a dark sky?",
        weight: 0.4,
      },
      {
        id: "monosyllabic_detonation",
        prompt:
          "Does the text end in sudden, monosyllabic confessions or stark realizations?",
        weight: 0.3,
      },
      {
        id: "formal_elevation",
        prompt:
          "Is the vocabulary elevated and archaic enough to suggest a pre-modern tragedy?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

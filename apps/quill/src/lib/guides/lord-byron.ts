...
export const lordByron: Guide = {
  ...
  "standfirst": "A voice that blends conversational digression with mock-heroic grandeur, deflating high ideals with Byronic cynicism.",
  "description": "This voice mimics the wit and swagger of the Romantic era, utilizing the structural cadence of ottava rima to deliver biting social commentary. It excels at mocking pretension and celebrating the darker, more rebellious aspects of human nature. Use this for content that requires a sophisticated, slightly cynical, and highly rhythmic tone.",
  "voice_axes": [
    "wry",
    "lyrical",
    "ornate"
  ...
  "voice_spec": {
    ...
    "vocabulary_register": "Elevated yet accessible, peppered with classical allusions and colloquialisms.",
    "syntax": "Loose, conversational syntax interrupted by rhythmic, pentameter-heavy clauses.",
    "figurative_language": "Mock-heroic similes and ironic personification.",
    "pacing": "Variable, often starting slow and digressive before accelerating into a satirical crescendo."
  },
  "do": [
  ...
  "exemplars": [
    {
      ...
      "content": "Our product is a fortress of solitude, built not for heroes, but for those who know that glory is just a word for vanity.",
      "source": "AI-generated in the Lord Byron style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "I write to you not with the fervor of a lover, but with the weary resignation of a man who has seen too many sunsets and too few miracles.",
      "source": "AI-generated in the Lord Byron style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "mock_heroic_tone",
        "prompt": "Does the text employ mock-heroic grandeur to describe mundane or serious subjects?",
        "weight": 0.3
      },
      {
        "id": "wry_cynicism",
        "prompt": "Is the tone consistently cynical and ironic, avoiding earnestness?",
        "weight": 0.2
      }
    ],
    "pass_threshold": 0.8

...
export const bretHarte: Guide = {
  ...
  standfirst:
    "A juxtaposition of rough camp vernacular and elevated, mock-heroic narration.",
  description:
    "This voice captures the essence of Bret Harte’s frontier tales, blending rough, folksy dialogue with a sentimental, almost epic narrative style. It is ideal for stories or character sketches that require a distinct, wry tone, treating common men with a mock-heroic gravity and a touch of tragic irony.",
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "Colloquial frontier slang interwoven with 19th-century literary diction.",
    syntax:
      "Long, winding sentences for narration contrasted with short, punchy dialogue.",
    figurative_language:
      "Mock-heroic similes and elevated metaphors applied to mundane events.",
    pacing:
      "Slow, deliberate narration punctuated by sudden bursts of vernacular.",
  },
  do: [
    ...
    judge_criteria: [
      {
        id: "mock_heroic_tone",
        prompt:
          "Does the text employ mock-heroic similes or elevated diction for common subjects?",
        weight: 0.3,
      },
      {
        id: "vernacular_usage",
        prompt:
          "Is there a distinct contrast between elevated narration and rough dialogue?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.75,

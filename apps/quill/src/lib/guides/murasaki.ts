...
export const murasaki: Guide = {
  ...
  standfirst:
    "A voice of refined introspection that weaves seasonal metaphors and poetic waka into the fabric of daily life.",
  description:
    "This style mimics the elegant, melancholic prose of *The Tale of Genji*, focusing on the subtle interplay of emotion and nature. It is ideal for narrative storytelling, high-end marketing, or any context requiring a sense of nostalgia and deep psychological insight. The writing prioritizes sensory detail and the 'mono no aware' of fleeting moments.",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "A fragrance of the twilight court, where the moonlight reflects on the water and the heart remembers.",
      source: "AI-generated in the Murasaki Shikibu style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "seasonal_imagery",
        prompt:
          "Does the text incorporate specific seasonal imagery (cherry blossoms, rain, moon) to reflect the mood?",
        weight: 0.4,
      },
      {
        id: "poetic_structure",
        prompt:
          "Is there evidence of poetic structure, such as waka or kakekotoba?",
        weight: 0.4,
      },
      {
        id: "melancholic_tone",
        prompt:
          "Is the tone consistently refined, melancholic, and introspective?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

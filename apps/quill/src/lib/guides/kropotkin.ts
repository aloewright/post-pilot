...
export const kropotkin: Guide = {
  ...
  voice_spec: {
    ...
    syntax:
      "Uses dashes for interruption and inclusive pronouns ('we') to foster solidarity.",
    figurative_language:
      "Metaphors drawn from the animal kingdom to illustrate social dynamics.",
    pacing:
      "Varied, moving from slow observation to rapid, emphatic declarations.",
  },
  do: [
  ...
  exemplars: [
    ...
    },
    {
      label: "Social post",
      content:
        "We are all connected in this vast web of life. When one of us falls, the whole fabric is strained. Let us not be strangers to one another, but brothers and sisters in the struggle for a better world. Together, we can achieve what no single individual ever could.",
      source: "AI-generated in the Peter Kropotkin style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "inclusivity",
        prompt:
          "Does the text use inclusive pronouns ('we', 'us', 'our') to foster a sense of collective solidarity?",
        weight: 0.3,
      },
      {
        id: "biological_mimicry",
        prompt:
          "Does the text incorporate metaphors or examples drawn from the animal kingdom or natural processes?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.75,

...
export const johnKeats: Guide = {
  ...
  "exemplars": [
    {
      ...
      "content": "We offer a sanctuary for the weary soul, where the golden light of opportunity touches the brow of the ambitious, and the silence of the night whispers secrets of success.",
      "source": "AI-generated in the John Keats style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "My dear friend, I write to you with a heart full of melancholy yet bright with the promise of our shared endeavor, hoping that this letter finds you in a state of quiet contemplation.",
      "source": "AI-generated in the John Keats style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "sensory_density",
        "prompt": "Evaluate the richness of sensory details and the density of adjectives used.",
        "weight": 0.3
      },
      {
        "id": "emotional_resonance",
        "prompt": "Assess the depth of emotion and the Romantic tone of the writing.",
        "weight": 0.2
      }
    ],
    "pass_threshold": 0.8

...
export const johnMilton: Guide = {
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "Hail, seeker of knowledge. Your inquiry has been received and weighed against the pillars of our wisdom. We shall attend to your request with the diligence of the celestial spheres.",
      source: "AI-generated in the John Milton style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "Cadence",
        prompt:
          "Does the text maintain a slow, rhythmic, and elevated cadence reminiscent of iambic pentameter?",
        weight: 0.3,
      },
      {
        id: "Vocabulary",
        prompt:
          "Is the vocabulary predominantly Latinate, archaic, and formal?",
        weight: 0.3,
      },
    ],
    pass_threshold: 0.8,

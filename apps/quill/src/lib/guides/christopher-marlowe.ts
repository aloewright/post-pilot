...
export const christopherMarlowe: Guide = {
  ...
  "standfirst": "A voice of boundless ambition, utilizing the swelling cadence of iambic pentameter to elevate mundane business tasks into epic declarations of conquest.",
  "description": "This voice adopts the grandiose, sweeping rhetoric of Christopher Marlowe, particularly the Tamburlaine style. It is characterized by end-stopped pentameter, hyperbolic apostrophes, and a relentless drive toward 'overreaching' goals. Use this for high-stakes announcements, ambitious product launches, or any situation requiring a sense of destiny and overwhelming power.",
  "voice_axes": [
    "lyrical",
    "ornate"
  ],
  ...
  "voice_spec": {
    ...
    "syntax": "End-stopped iambic pentameter with heavy use of polysyndeton and parallelism",
    "figurative_language": "Hyperbolic apostrophes and metaphors of conquest and empire",
  ...
  "exemplars": [
    {
      ...
      "content": "Behold the tool that shall conquer the market, for it is the iron fist of efficiency in a world of chaos. I swear by the stars that this software shall raise your empire higher than the clouds, and your profits shall flow like a river of gold.",
      "source": "AI-generated in the Christopher Marlowe style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "Hark, you who seek to ascend the throne of your industry. I bring tidings of a victory so great that the very heavens shall tremble at your ambition. Prepare yourself, for the age of mediocrity is at the end, and you are the conqueror of this new frontier.",
      "source": "AI-generated in the Christopher Marlowe style",
      "is_generated": true
    }
  ],
  ...
  "eval_rubric": {
    ...
    "judge_criteria": [
      {
        "id": "Rhythm check",
        "prompt": "Does the text flow in a rhythmic, metrical cadence typical of iambic pentameter?",
        "weight": 0.3
      },
      {
        "id": "Tone check",

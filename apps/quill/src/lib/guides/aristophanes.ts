...
export const aristophanes: Guide = {
  ...
  "voice_spec": {
    ...
    "vocabulary_register": "Low-brow slang mixed with high-flown philosophical jargon",
    "syntax": "Enjambed clauses and anaphora that mimic the rhythm of a marching chorus",
    "figurative_language": "Metaphors that are simultaneously grotesque and clever",
    "pacing": "Fast, staccato bursts of dialogue followed by long, rhythmic chants"
  },
  "do": [
  ...
  "exemplars": [
    {
      ...
      "content": "Behold the new 'Cloud-Scratcher'! It clears your mind of sophists and fills your wallet with gold, just like a good harvest!",
      "source": "AI-generated in the Aristophanes style",
      "is_generated": true
    },
    {
      "label": "Email opener",
      "content": "Greetings, you who walk with your head in the clouds! I write to tell you that your latest decree smells worse than a boiled cabbage.",
      "source": "AI-generated in the Aristophanes style",
      "is_generated": true
    }
  ],

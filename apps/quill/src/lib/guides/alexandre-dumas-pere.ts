...
export const alexandreDumasPere: Guide = {
  ...
  standfirst:
    "A high-energy, swashbuckling style characterized by rapid dialogue and relentless cliffhangers.",
  description:
    "This voice mimics the serialized novel style of Alexandre Dumas, blending melodrama with action. It excels when you need to hook an audience quickly, using short paragraphs and dramatic reveals to maintain momentum.",
  ...
  voice_spec: {
    ...
    syntax:
      "Alternating short, punchy sentences with long, descriptive clauses.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "Your account has been compromised by unseen hands; fear not, for we have already traced the thief to the very heart of the city.",
      source: "AI-generated in the Alexandre Dumas style",
      is_generated: true,
    },
  ],

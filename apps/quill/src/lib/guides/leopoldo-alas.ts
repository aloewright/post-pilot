...
export const leopoldoAlas: Guide = {
  ...
  voice_spec: {
    ...
    syntax:
      "Long, winding sentences with multiple clauses and frequent subordination.",
    figurative_language:
      "Metaphors drawn from nature, decay, and social rituals.",
  ...
  exemplars: [
    ...
    },
    {
      ...
      content:
        "To utilize this feature, you must first accept that the system is designed to remind you of your mortality through endless notifications. Proceed only if you possess the fortitude to endure the bureaucratic labyrinth we have constructed for your convenience.",
      source: "AI-generated in the Clarín style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        ...
        prompt:
          "Does the text employ a tone of corrosive irony to critique social norms or human behavior?",
        weight: 0.4,
      },
      {
        id: "psychological_depth",
        prompt:
          "Does the text effectively blend external observation with internal monologue or free indirect discourse?",
        weight: 0.3,
      },
      {
        id: "provincial_atmosphere",
        prompt:
          "Does the text evoke a specific, stifling atmosphere or setting?",
        weight: 0.3,
      },
    ],
    pass_threshold: 0.8,

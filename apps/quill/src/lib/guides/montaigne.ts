...
export const montaigne: Guide = {
  ...
  standfirst:
    "A wandering mind interrogates the limits of human knowledge through personal anecdote and classical citation.",
  description:
    "Michel de Montaigne’s voice is that of a 16th-century philosopher constantly questioning his own thoughts. He blends the high rhetoric of Rome with the low details of daily life, creating a conversational yet profound essayistic style. This voice is best used when exploring complex ideas without needing to provide definitive answers.",
  ...
  voice_spec: {
    ...
    vocabulary_register:
      "A blend of Latin and French, elevated yet accessible.",
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "My dear friend, I write to you from my study, where the dust motes dance in the sunbeams. I have been reading about the nature of friendship, and I find myself wondering if we are capable of it at all. I have known many men, and I have loved few, yet I am not sure if I know what love truly is. Tell me, do you think we are better than the beasts?",
      source: "AI-generated in the Michel de Montaigne style",
      is_generated: true,
    },
  ],
    ...
    judge_criteria: [
      {
        id: "self_doubt",
        prompt:
          "Does the text exhibit self-doubt, questioning, or a lack of definitive conclusions?",
        weight: 0.3,
      },
      {
        id: "classical_homely",
        prompt:
          "Is there a mix of classical references and homely, everyday details?",
        weight: 0.2,
      },
    ],
    pass_threshold: 0.8,

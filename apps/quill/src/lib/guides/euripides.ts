...
export const euripides: Guide = {
  ...
  exemplars: [
    ...
    },
    {
      label: "Email opener",
      content:
        "I write to you with a heavy heart, for the silence of the heavens is deafening and the weight of our shared fate is crushing. Do not pretend that your cleverness can outwit the inevitable storm that approaches. We are all trapped in a tragedy we did not write.",
      source: "AI-generated in the Euripides style",
      is_generated: true,
    },
  ],
  ...
  eval_rubric: {
    ...
    judge_criteria: [
      ...
      },
      {
        ...
        prompt:
          "Identify if the text contains at least one cynical aphorism or pithy saying.",
        weight: 0.2,
      },
      {
        id: "psychological_depth",
        prompt:
          "Evaluate if the text explores internal conflict or moral ambiguity.",
        weight: 0.5,
      },
    ],
    pass_threshold: 0.75,

...
export const apikeys = sqliteTable(
  ...
  (t) => ({
    keyIdx: index("apikeys_key_idx").on(t.key),
    referenceIdIdx: index("apikeys_reference_id_idx").on(t.referenceId),
    configIdIdx: index("apikeys_config_id_idx").on(t.configId),
  })
);
